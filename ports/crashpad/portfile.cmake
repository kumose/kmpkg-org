...
x_kmpkg_get_python_packages(OUT_PYTHON_VAR PYTHON3
...
if(NOT EXISTS "${SOURCE_PATH}/third_party/mini_chromium/mini_chromium/BUILD.gn")
    kmpkg_from_git(OUT_SOURCE_PATH mini_chromium
...
if(NOT EXISTS "${SOURCE_PATH}/third_party/lss/lss/BUILD.gn" AND (KMPKG_TARGET_IS_ANDROID OR KMPKG_TARGET_IS_LINUX))
    kmpkg_from_git(OUT_SOURCE_PATH lss
...
function(replace_gn_dependency INPUT_FILE OUTPUT_FILE LIBRARY_NAMES)
    ...
    if(KMPKG_BUILD_TYPE STREQUAL "release")
...
set(OPTIONS "target_cpu=\"${KMPKG_TARGET_ARCHITECTURE}\"")
...
if(KMPKG_TARGET_IS_ANDROID)
    ...
    string(APPEND OPTIONS " target_os=\"android\" android_ndk_root=\"${KMPKG_DETECTED_CMAKE_ANDROID_NDK}\"")
...
elseif(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    set(OPTIONS_DBG "${OPTIONS_DBG} \
        extra_cflags_c=\"${KMPKG_COMBINED_C_FLAGS_DEBUG}\" \
        extra_cflags_cc=\"${KMPKG_COMBINED_CXX_FLAGS_DEBUG}\" \
        extra_ldflags=\"${KMPKG_COMBINED_SHARED_LINKER_FLAGS_DEBUG}\" \
        extra_arflags=\"${KMPKG_COMBINED_STATIC_LINKER_FLAGS_DEBUG}\"")

    set(OPTIONS_REL "${OPTIONS_REL} \
        extra_cflags_c=\"${KMPKG_COMBINED_C_FLAGS_RELEASE}\" \
        extra_cflags_cc=\"${KMPKG_COMBINED_CXX_FLAGS_RELEASE}\" \
        extra_ldflags=\"${KMPKG_COMBINED_SHARED_LINKER_FLAGS_RELEASE}\" \
        extra_arflags=\"${KMPKG_COMBINED_STATIC_LINKER_FLAGS_RELEASE}\"")
