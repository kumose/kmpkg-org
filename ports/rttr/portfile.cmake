...
if("${KMPKG_LIBRARY_LINKAGE}" STREQUAL "static" AND "${KMPKG_CRT_LINKAGE}" STREQUAL "static")
    set(BUILD_STATIC ON)
    set(BUILD_RTTR_DYNAMIC OFF)
    set(BUILD_WITH_STATIC_RUNTIME_LIBS OFF)
elseif("${KMPKG_LIBRARY_LINKAGE}" STREQUAL "dynamic" AND "${KMPKG_CRT_LINKAGE}" STREQUAL "static")
    set(BUILD_STATIC OFF)
    set(BUILD_RTTR_DYNAMIC OFF)
    set(BUILD_WITH_STATIC_RUNTIME_LIBS ON)
elseif("${KMPKG_LIBRARY_LINKAGE}" STREQUAL "dynamic" AND "${KMPKG_CRT_LINKAGE}" STREQUAL "dynamic")
    set(BUILD_STATIC OFF)
    set(BUILD_RTTR_DYNAMIC ON)
    set(BUILD_WITH_STATIC_RUNTIME_LIBS OFF)
else()
    message(FATAL_ERROR "rttr's build system does not support this configuration: KMPKG_LIBRARY_LINKAGE: ${KMPKG_LIBRARY_LINKAGE} KMPKG_CRT_LINKAGE: ${KMPKG_CRT_LINKAGE}")
endif()
...
if (KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_cmake_config_fixup(CONFIG_PATH share/rttr/cmake)
endif()
