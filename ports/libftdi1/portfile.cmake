...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" STATICLIBS)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/libftdi1)
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/${PORT}/LibFTDI1Config.cmake" "/lib/cmake/${PORT}/" "/share/${PORT}/")
if(NOT KMPKG_BUILD_TYPE)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/${PORT}/LibFTDI1Config-debug.cmake" "/debug/lib/cmake/${PORT}/" "/share/${PORT}/")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/${PORT}/LibFTDI1Config-debug.cmake" "{_IMPORT_PREFIX}" "{KMPKG_IMPORT_PREFIX}")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/${PORT}/LibFTDI1Config-debug.cmake" "{KMPKG_IMPORT_PREFIX}/debug/include/" "{KMPKG_IMPORT_PREFIX}/include/")
