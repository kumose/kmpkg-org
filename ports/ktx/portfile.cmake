...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_list(APPEND OPTIONS "-DBASH_EXECUTABLE=${MSYS_ROOT}/usr/bin/bash.exe")
endif()
if(KMPKG_TARGET_IS_APPLE AND KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
    kmpkg_list(APPEND OPTIONS "-DASTCENC_ISA_SSE41=ON") # use x86_64, not x64_64h
endif()
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        -DKTX_GIT_VERSION_FULL=v${VERSION}-kmpkg
...
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/ktx)
