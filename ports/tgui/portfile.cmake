...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" TGUI_USE_STATIC_STD_LIBS)
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/TGUI)
kmpkg_copy_pdbs()

if("tool" IN_LIST FEATURES)
    message(STATUS "Check for: ${TGUI_SHARE_PATH}/gui-builder/gui-builder${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
    if(EXISTS "${TGUI_SHARE_PATH}/gui-builder/gui-builder${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
        file(MAKE_DIRECTORY "${TGUI_TOOLS_PATH}")
        file(RENAME
            "${TGUI_SHARE_PATH}/gui-builder/gui-builder${KMPKG_TARGET_EXECUTABLE_SUFFIX}"
            "${TGUI_TOOLS_PATH}/gui-builder${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
        ...
        kmpkg_copy_tool_dependencies("${TGUI_TOOLS_PATH}")
    endif()
endif()
