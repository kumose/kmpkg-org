function(lib_to_def)
    if(NOT KMPKG_TARGET_IS_WINDOWS OR KMPKG_TARGET_IS_MINGW OR NOT KMPKG_LIBRARY_LINKAGE STREQUAL "static")
        return()
    endif()
    ...
    list(JOIN symbols "\n" symbols)
    set(symbols "EXPORTS\n${symbols}\n")
    set(def_file "${CMAKE_CURRENT_LIST_DIR}/${arg_BASENAME}-${KMPKG_TARGET_ARCHITECTURE}.def")
    ...
    if(NOT symbols STREQUAL original_symbols)
        file(WRITE "${CURRENT_BUILDTREES_DIR}/${arg_BASENAME}-${KMPKG_TARGET_ARCHITECTURE}.def.log" "${symbols}")
        message(SEND_ERROR "${arg_BASENAME}-${KMPKG_TARGET_ARCHITECTURE}.def has changed.")
    endif()
endfunction()
