...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" CASC_BUILD_SHARED_LIB)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" CASC_BUILD_STATIC_LIB)
...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    message(STATUS "See the overlay ports documentation at https://github.com/microsoft/kmpkg/blob/master/docs/specifications/ports-overlay.md")
endif()
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/CascLib)
