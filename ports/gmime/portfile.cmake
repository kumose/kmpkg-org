...
set(iconv_detect_h "${CURRENT_HOST_INSTALLED_DIR}/share/${PORT}/iconv-detect-${KMPKG_CMAKE_SYSTEM_NAME}.h")
if(EXISTS "${iconv_detect_h}")
    kmpkg_list(APPEND options "ac_cv_have_iconv_detect_h=yes")
elseif(KMPKG_CROSSCOMPILING)
    kmpkg_list(APPEND options "ac_cv_have_iconv_detect_h=no")
endif()

if("crypto" IN_LIST FEATURES)
    kmpkg_list(APPEND options "--enable-crypto")
else()
    kmpkg_list(APPEND options "--disable-crypto")
endif()
...
if(NOT KMPKG_CROSSCOMPILING)
    file(INSTALL "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/iconv-detect.h"
        ...
        RENAME "iconv-detect-${KMPKG_CMAKE_SYSTEM_NAME}.h"
    )
endif()
