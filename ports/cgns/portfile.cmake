...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" CGNS_BUILD_SHARED)
...
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/cgns")
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/cgnslib.h" "defined(USE_DLL)" "1")
endif()
