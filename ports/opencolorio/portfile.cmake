...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        tools   KMPKG_LOCK_FIND_PACKAGE_OpenGL
)

if(NOT KMPKG_TARGET_ARCHITECTURE MATCHES "^arm")
...
kmpkg_cmake_configure(
    ...
    MAYBE_UNUSED_VARIABLES
        ...
        KMPKG_LOCK_FIND_PACKAGE_OpenGL

)

kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/OpenColorIO")
