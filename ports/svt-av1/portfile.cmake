...
if (KMPKG_TARGET_ARCHITECTURE MATCHES "^(x86|x64)")
    kmpkg_find_acquire_program(NASM)
    set(SIMD_OPTIONS -DCOMPILE_C_ONLY=OFF "-DCMAKE_ASM_NASM_COMPILER=${NASM}")
else()
    if(KMPKG_TARGET_ARCHITECTURE MATCHES "^(arm64|arm64ec)$" AND NOT KMPKG_TARGET_IS_WINDOWS)
...
if("tool" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES SvtAv1EncApp AUTO_CLEAN)
endif()
