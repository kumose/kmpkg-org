kmpkg_download_distfile(BOOST_1_89_0_COMPAT_PATCH
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" PCL_SHARED_LIBS)

if(KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64" OR KMPKG_TARGET_ARCHITECTURE STREQUAL "arm")
...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        examples        KMPKG_LOCK_FIND_PACKAGE_cJSON
        libusb          WITH_LIBUSB
        opengl          WITH_OPENGL
        ...
        surface-on-nurbs KMPKG_LOCK_FIND_PACKAGE_ZLIB
        tools           BUILD_tools
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DWITH_RSSDK2=OFF
        # Misc
        -DKMPKG_LOCK_FIND_PACKAGE_ClangFormat=OFF
        # FEATURES
        ${FEATURE_OPTIONS}
    OPTIONS_DEBUG
        -DBUILD_apps=OFF
...
if(BUILD_tools OR BUILD_apps OR BUILD_examples)
    file(GLOB tool_names
        ...
        "${CURRENT_PACKAGES_DIR}/bin/*${KMPKG_TARGET_EXECUTABLE_SUFFIX}"
    )
    if(KMPKG_TARGET_EXECUTABLE_SUFFIX)
        string(REPLACE "." "[.]" suffix "${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
