...
kmpkg_configure_meson(
    ...
    OPTIONS
        ...
        -Dtests=disabled
    ADDITIONAL_BINARIES
        "gperf = ['${CURRENT_HOST_INSTALLED_DIR}/tools/gperf/gperf${KMPKG_HOST_EXECUTABLE_SUFFIX}']"
)
...
kmpkg_replace_string("${configfile}" "${CURRENT_PACKAGES_DIR}" "${replacement}")
...
if("nls" IN_LIST FEATURES AND KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    if(NOT KMPKG_BUILD_TYPE)
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/fontconfig.pc" "-liconv" "-liconv -lintl" IGNORE_UNCHANGED)
    endif()
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/fontconfig.pc" "-liconv" "-liconv -lintl" IGNORE_UNCHANGED)
endif()
...
if(NOT KMPKG_BUILD_TYPE)
    ...
    kmpkg_replace_string("${fontconfig_pc_debug}" "/etc" "/../etc" REGEX)
    kmpkg_replace_string("${fontconfig_pc_debug}" "/var" "/../var" REGEX)
endif()

# Make path to cache in fonts.conf relative
set(_file "${CURRENT_PACKAGES_DIR}/etc/fonts/fonts.conf")
if(EXISTS "${_file}")
    kmpkg_replace_string("${_file}" "${CURRENT_PACKAGES_DIR}/var/cache/fontconfig" "./../../var/cache/fontconfig" IGNORE_UNCHANGED)
endif()
