...
kmpkg_check_features(OUT_FEATURE_OPTIONS none # only using the script-mode side-effects
    FEATURES
...
configure_file("${CMAKE_CURRENT_LIST_DIR}/sqlite3-kmpkg-config.h.in" "${SOURCE_PATH}/sqlite3-kmpkg-config.h" @ONLY)
...
if("tool" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES sqlite3 DESTINATION "${CURRENT_PACKAGES_DIR}/tools" AUTO_CLEAN)
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    configure_file("${CURRENT_PORT_DIR}/kmpkg-cmake-wrapper.cmake" "${CURRENT_PACKAGES_DIR}/share/${PORT}/kmpkg-cmake-wrapper.cmake" @ONLY)
endif()
