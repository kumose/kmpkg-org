...
if("tools" IN_LIST FEATURES)
    kmpkg_list(APPEND FEATURE_OPTIONS --enable-tools)
endif()

if("cyrus-sasl" IN_LIST FEATURES)
    kmpkg_list(APPEND FEATURE_OPTIONS --with-cyrus-sasl)
else()
    kmpkg_list(APPEND FEATURE_OPTIONS --without-cyrus-sasl)
endif()

if(KMPKG_TARGET_IS_ANDROID)
    kmpkg_list(APPEND FEATURE_OPTIONS -with-yielding_select=yes)
endif()
...
kmpkg_make_install(TARGETS depend install)
