...
set(FLATC_EXEC "${CURRENT_HOST_INSTALLED_DIR}/tools/flatbuffers/flatc${KMPKG_HOST_EXECUTABLE_SUFFIX}")
...
if(KMPKG_TARGET_IS_WINDOWS)
    string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" USE_RUNTIME_MT)
...
kmpkg_download_distfile(COPYRIGHT_PATH
...
if("tools" IN_LIST FEATURES)
    ...
    if(BUILD_SHARED)
        kmpkg_copy_tools(TOOL_NAMES TestConvertResult AUTO_CLEAN) # tools/converter
    endif()
endif()
