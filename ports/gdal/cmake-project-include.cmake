if(GDAL_USE_KEA)
    ...
    set(GDAL_CHECK_PACKAGE_KEA_NAMES Kealib CACHE INTERNAL "kmpkg")
    set(GDAL_CHECK_PACKAGE_KEA_TARGETS Kealib::Kealib CACHE INTERNAL "kmpkg")
endif()

if(GDAL_USE_WEBP)
    find_package(WebP CONFIG REQUIRED)
    add_library(WEBP::WebP ALIAS WebP::webp)
    set(GDAL_CHECK_PACKAGE_WebP_NAMES WebP CACHE INTERNAL "kmpkg")
    set(GDAL_CHECK_PACKAGE_WebP_TARGETS WebP::webp CACHE INTERNAL "kmpkg")
endif()
...
if(GDAL_USE_SQLITE3)
    # CMake find module with kmpkg cmake wrapper
