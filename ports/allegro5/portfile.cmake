kmpkg_from_github(
    ...
    PATCHES
        ...
        skip-android-aar.diff          # Building AAR, not needed for kmpkg
)

if(KMPKG_TARGET_IS_ANDROID AND "$ENV{ANDROID_HOME}" STREQUAL "")
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" KMPKG_BUILD_SHARED_LIBS)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DSHARED=${KMPKG_BUILD_SHARED_LIBS}
        ${options}
        -DALLEGRO_SDL=OFF
        -DWANT_D3D9EX=OFF # Not available on kmpkg
        -DWANT_DEMO=OFF
        -DWANT_DOCS=OFF
        -DWANT_EXAMPLES=OFF
        -DWANT_GLES3=ON
        -DWANT_IMAGE_FREEIMAGE=OFF
        -DWANT_MODAUDIO=OFF # Not available on kmpkg right now
        -DWANT_MP3=ON
        -DWANT_OPENSL=OFF # Not yet available on kmpkg
        -DWANT_POPUP_EXAMPLES=OFF
        -DWANT_TESTS=OFF
        -DWANT_TREMOR=OFF # Not yet available on kmpkg
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/allegro)
