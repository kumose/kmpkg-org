...
if(KMPKG_TARGET_IS_IOS OR KMPKG_TARGET_IS_UWP)
...
if(KMPKG_TARGET_IS_IOS)
    ...
    list(APPEND FEATURE_OPTIONS "-DIOS_DEPLOYMENT_TARGET=${KMPKG_OSX_DEPLOYMENT_TARGET}")
endif()
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_CUDAToolkit=ON
        -DKMPKG_LOCK_FIND_PACKAGE_gflags=OFF  # No direct use except examples+tests
        -DKMPKG_LOCK_FIND_PACKAGE_LAPACK=ON
    MAYBE_UNUSED_VARIABLES
        MSVC_USE_STATIC_CRT
        KMPKG_LOCK_FIND_PACKAGE_CUDAToolkit
        KMPKG_LOCK_FIND_PACKAGE_LAPACK
)
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/Ceres")
