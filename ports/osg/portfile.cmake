...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" OSG_DYNAMIC)
...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        sdl1        KMPKG_LOCK_FIND_PACKAGE_SDL
)
...
kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-osg)

# Add debug folder prefix for plugin targets. kmpkg_cmake_config_fixup only handles this for targets in bin/ and lib/.
...
if("examples" IN_LIST FEATURES AND KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
...
if(tools)
    set(osg_plugin_pattern "${KMPKG_TARGET_SHARED_LIBRARY_PREFIX}osgdb*${KMPKG_TARGET_SHARED_LIBRARY_SUFFIX}")
...
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/openscenegraph.pc" "\\\n" " ")
if(NOT KMPKG_BUILD_TYPE)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/openscenegraph.pc" "\\\n" " ")
endif()
