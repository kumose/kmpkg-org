...
# Will use kmpkg to find these packages
file(REMOVE_RECURSE
...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        gui         WITH_QT
        gui         KMPKG_LOCK_FIND_PACKAGE_Qt6
        gui         KMPKG_LOCK_FIND_PACKAGE_VTK
        k4w2        WITH_K4W2
        k4w2        KMPKG_LOCK_FIND_PACKAGE_KinectSDK2
        octomap     WITH_OCTOMAP
        octomap     KMPKG_LOCK_FIND_PACKAGE_octomap
        openmp      WITH_OPENMP
        openmp      KMPKG_LOCK_FIND_PACKAGE_OpenMP
        openni2     WITH_OPENNI2
        openni2     KMPKG_LOCK_FIND_PACKAGE_OpenNI2
        realsense2  WITH_REALSENSE2
        realsense2  KMPKG_LOCK_FIND_PACKAGE_realsense2
        tools       BUILD_APP
        tools       BUILD_TOOLS
)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ${FEATURE_OPTIONS}
        "-DRTABMAP_RES_TOOL=${CURRENT_HOST_INSTALLED_DIR}/tools/rtabmap-res-tool/rtabmap-res_tool${KMPKG_TARGET_EXECUTABLE_SUFFIX}"
        -DRTABMAP_QT_VERSION=6
        -DBUILD_AS_BUNDLE=OFF
        -DBUILD_EXAMPLES=OFF
        -DKMPKG_LOCK_FIND_PACKAGE_SQLite3=ON
        ## always on feats
        -DWITH_G2O=ON  -DKMPKG_LOCK_FIND_PACKAGE_g2o=ON
        -DWITH_CERES=ON
    ...
    MAYBE_UNUSED_VARIABLES
        KMPKG_LOCK_FIND_PACKAGE_Qt6
        KMPKG_LOCK_FIND_PACKAGE_VTK
        KMPKG_LOCK_FIND_PACKAGE_KinectSDK2
        KMPKG_LOCK_FIND_PACKAGE_octomap
        KMPKG_LOCK_FIND_PACKAGE_OpenMP
        KMPKG_LOCK_FIND_PACKAGE_OpenNI2
        KMPKG_LOCK_FIND_PACKAGE_realsense2
        KMPKG_LOCK_FIND_PACKAGE_RealSense2
        # Android
        WITH_ARCore
        WITH_ARENGINE
...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_cmake_config_fixup(CONFIG_PATH lib/rtabmap-0.23)
endif()
...
if("tools" IN_LIST FEATURES)
  ...
  if("gui" IN_LIST FEATURES)
    ...
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/qt.conf" "./../../../" "./../../")
  endif()
endif()
