    ...
    foreach(PROJ_FILE ${PROJ_FILES})
        ...
        STRING(REGEX
            REPLACE
                ...
                "<Target Name=\"EnsureNuGetPackageBuildImports\" BeforeTargets=\"PrepareForBuild\" Condition=\"'$(UseKmpkg)' != 'yes'\">"
            PROJ_FILE_CONTENT
            "${PROJ_FILE_CONTENT}"
        )
        ...
        kmpkg_execute_required_process(
            COMMAND pwsh ${CURRENT_PORT_DIR}/change_to_mt.ps1 ${PROJ_FILE} ${KMPKG_CRT_LINKAGE}
