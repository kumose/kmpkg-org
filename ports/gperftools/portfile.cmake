...
if("override" IN_LIST FEATURES)
    kmpkg_check_linkage(ONLY_STATIC_LIBRARY ONLY_STATIC_CRT)
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    ...
    foreach(gperf_header IN LISTS gperf_public_headers)
        kmpkg_replace_string("${gperf_header}" "__declspec(dllimport)" "")
    endforeach()
endif()

if("tools" IN_LIST FEATURES)
    if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
        kmpkg_copy_tools(TOOL_NAMES addr2line-pdb nm-pdb AUTO_CLEAN)
    endif()
    # Perl script
