...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" CGLM_BUILD_SHARED)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" CGLM_BUILD_STATIC)
...
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/cglm")
