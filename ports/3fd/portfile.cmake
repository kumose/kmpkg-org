...
kmpkg_check_linkage(ONLY_STATIC_LIBRARY ONLY_DYNAMIC_CRT)
...
elseif (KMPKG_TARGET_IS_WINDOWS) # Win32:
    ...
    message(FATAL_ERROR "Unsupported system: 3FD is not currently ported to KMPKG in ${KMPKG_CMAKE_SYSTEM_NAME}!")
endif()
