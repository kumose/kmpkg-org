...
if("tao" IN_LIST FEATURES)
    # Don't change to kmpkg_from_github! This points to a release and not an archive
...
if(KMPKG_TARGET_IS_WINDOWS)
  if(KMPKG_PLATFORM_TOOLSET MATCHES "v140")
    set(SOLUTION_TYPE vc14)
  elseif(KMPKG_PLATFORM_TOOLSET MATCHES "v141")
    set(SOLUTION_TYPE vs2017)
  elseif(KMPKG_PLATFORM_TOOLSET MATCHES "v142")
...
elseif (KMPKG_TARGET_IS_ANDROID)
  ...
  set(ENV{ANDROID_ABI} "${KMPKG_DETECTED_CMAKE_ANDROID_ARCH_ABI}")
  set(ENV{android_ndk} "${KMPKG_DETECTED_CMAKE_ANDROID_NDK}")
  set(ENV{android_api} "${KMPKG_DETECTED_CMAKE_SYSTEM_VERSION}")
endif()
...
elseif(KMPKG_TARGET_IS_LINUX OR KMPKG_TARGET_IS_OSX OR KMPKG_TARGET_IS_ANDROID)
...
if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "debug")
  ...
  kmpkg_execute_build_process(
    COMMAND make ${_ace_makefile_macros} "debug=1" "optimize=0" "-j${KMPKG_CONCURRENCY}"
...
if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
  ...
  kmpkg_execute_build_process(
    COMMAND make ${_ace_makefile_macros} "-j${KMPKG_CONCURRENCY}"
    WORKING_DIRECTORY "${WORKING_DIR}"
