# Set KMPKG_POLICY_DLLS_IN_STATIC_LIBRARY instead of using `kmpkg_check_linkage` because
...
if(KMPKG_TARGET_ARCHITECTURE MATCHES "arm64|arm64ec")
    set(DS_ARCH arm64)
else()
    set(DS_ARCH ${KMPKG_TARGET_ARCHITECTURE})
endif()
