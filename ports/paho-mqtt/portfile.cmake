...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" PAHO_BUILD_DYNAMIC)
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(PACKAGE_NAME eclipse-paho-mqtt-c CONFIG_PATH lib/cmake/eclipse-paho-mqtt-c)
kmpkg_copy_pdbs()

if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    kmpkg_copy_tools(TOOL_NAMES MQTTVersion AUTO_CLEAN)
endif()

if(KMPKG_TARGET_IS_WINDOWS OR KMPKG_TARGET_IS_OSX)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/eclipse-paho-mqtt-c/eclipse-paho-mqtt-cConfig.cmake"
        [[# Generated by CMake]]
        [[# Generated by CMake
