...
if(KMPKG_TARGET_IS_WINDOWS)
    if (NOT KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
        ...
        file(COPY
            "${SOURCE_PATH}/lib/win/hostapp/${KMPKG_TARGET_ARCHITECTURE}/tycam.lib"
            DESTINATION "${CURRENT_PACKAGES_DIR}/lib"
        )
        file(COPY
            "${SOURCE_PATH}/lib/win/hostapp/${KMPKG_TARGET_ARCHITECTURE}/tycam.dll"
...
elseif(KMPKG_TARGET_IS_LINUX)
    ...
    elseif (KMPKG_TARGET_ARCHITECTURE STREQUAL "x86")
        ...
        set (CAMPORT3_ARCH ${KMPKG_TARGET_ARCHITECTURE})
    endif()
