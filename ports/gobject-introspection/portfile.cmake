...
include("${CURRENT_PORT_DIR}/kmpkg-port-config.cmake")
kmpkg_get_gobject_introspection_programs(PYTHON3)
...
# KMPKG_GI_... variables are used by, and scoped to, giscanner
set(ENV{KMPKG_GI_LIBDIR} "${CURRENT_INSTALLED_DIR}/lib")
set(ENV{KMPKG_GI_DATADIR} "${CURRENT_PACKAGES_DIR}/share")
file(MAKE_DIRECTORY "$ENV{KMPKG_GI_DATADIR}/gir-1.0")
if(KMPKG_TARGET_IS_WINDOWS)
    set(ENV{KMPKG_GI_LIBDIR_VAR} "LIB")
elseif(KMPKG_TARGET_IS_OSX OR KMPKG_TARGET_IS_IOS)
    set(ENV{KMPKG_GI_LIBDIR_VAR} "DYLD_LIBRARY_PATH")
else()
    set(ENV{KMPKG_GI_LIBDIR_VAR} "LD_LIBRARY_PATH")
endif()
...
endforeach()
kmpkg_copy_tools(TOOL_NAMES g-ir-compiler g-ir-generate g-ir-inspect AUTO_CLEAN)

file(GLOB pcfiles "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/*.pc")
foreach(file IN LISTS pcfiles)
    kmpkg_replace_string("${file}" [[=${bindir}/g-ir-]] [[=${prefix}/tools/gobject-introspection/g-ir-]])
endforeach()
