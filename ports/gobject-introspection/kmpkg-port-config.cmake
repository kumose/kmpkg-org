...
function(z_kmpkg_get_gobject_introspection_python out_var)
    ...
    set(target_python "${CURRENT_INSTALLED_DIR}/tools/python3/python3${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
    if(KMPKG_TARGET_IS_WINDOWS)
        set(target_python "${CURRENT_INSTALLED_DIR}/tools/python3/python.exe")
    endif()
    
    # Varation of x_kmpkg_get_python_packages, but
    ...
    set(gobject_introspection_python "${venv_path}${python_sub_path}/python${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
...
function(kmpkg_get_gobject_introspection_programs)
    if("PYTHON3" IN_LIST ARGN)
        z_kmpkg_get_gobject_introspection_python(PYTHON3)
        set(PYTHON3 "${PYTHON3}" PARENT_SCOPE)
        list(REMOVE_ITEM ARGN "PYTHON3")
    endif()
    if("GIR_COMPILER" IN_LIST ARGN)
        set(GIR_COMPILER "${CURRENT_INSTALLED_DIR}/tools/gobject-introspection/g-ir-compiler${KMPKG_TARGET_EXECUTABLE_SUFFIX}" PARENT_SCOPE)
