...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    set(KMPKG_POLICY_DLLS_WITHOUT_EXPORTS enabled)
...
elseif(KMPKG_TARGET_IS_LINUX)
    ...
    set(CFLAGS "${KMPKG_CXX_FLAGS} ${KMPKG_CXX_FLAGS_DEBUG} -fPIC -O0 -g -I${SOURCE_PATH}/include")
    set(LDFLAGS "${KMPKG_LINKER_FLAGS}")
    #create makefile
    ...
    set(CFLAGS "${KMPKG_CXX_FLAGS} ${KMPKG_CXX_FLAGS_RELEASE} -fPIC -O3 -I${SOURCE_PATH}/include")
    set(LDFLAGS "${KMPKG_LINKER_FLAGS}")
    kmpkg_execute_required_process(
