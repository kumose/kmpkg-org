...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" PHYSFS_STATIC)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" PHYSFS_SHARED)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/PhysFS)
kmpkg_fixup_pkgconfig()

if(PHYSFS_STATIC)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/physfs.h" "defined(PHYSFS_STATIC)" "1")
else()
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/physfs.h" "dllexport" "dllimport")
endif()
