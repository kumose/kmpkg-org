...
if(KMPKG_TARGET_IS_WINDOWS)
  ...
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/dlib/config.h" "/* #undef ENABLE_ASSERTS */" "#if defined(_DEBUG)\n#define ENABLE_ASSERTS\n#endif")
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/dlib/config.h" "#define DLIB_DISABLE_ASSERTS" "#if !defined(_DEBUG)\n#define DLIB_DISABLE_ASSERTS\n#endif")
endif()

kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/dlib)
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/dlib/LICENSE.txt")
