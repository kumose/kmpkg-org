...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static"  STATIC_CRT_LINKAGE)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DWITH_CURL=none
        -DWITH_EDITLINE=bundled # not in kmpkg
        -DWITH_LZ4=system
...
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-libmysql)
...
kmpkg_copy_tools(TOOL_NAMES ${MYSQL_TOOLS} AUTO_CLEAN)
...
if (NOT KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_replace_string("${MYSQL_CONFIG_FILE}" "/bin/mysql_.*config" "/tools/libmysql/mysql_.*config")
    kmpkg_replace_string("${MYSQL_CONFIG_FILE}" "'${CURRENT_PACKAGES_DIR}" "\"\$basedir\"\'")
endif()
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/LICENSE" "${libedit_copying}")
