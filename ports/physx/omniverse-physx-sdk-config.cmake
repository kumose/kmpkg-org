...
if(NOT TARGET unofficial::omniverse-physx-sdk)
    ...
    get_filename_component(z_kmpkg_omniverse_physx_sdk_prefix "${CMAKE_CURRENT_LIST_FILE}" PATH)
    get_filename_component(z_kmpkg_omniverse_physx_sdk_prefix "${z_kmpkg_omniverse_physx_sdk_prefix}" PATH)
    get_filename_component(z_kmpkg_omniverse_physx_sdk_prefix "${z_kmpkg_omniverse_physx_sdk_prefix}" PATH)

    get_filename_component(OMNIVERSE-PHYSX-SDK_INCLUDE_DIRS "${z_kmpkg_omniverse_physx_sdk_prefix}/include/physx" ABSOLUTE)
    get_filename_component(OMNIVERSE-PHYSX-SDK_RELEASE_LIBS_DIR "${z_kmpkg_omniverse_physx_sdk_prefix}/lib" ABSOLUTE)
    get_filename_component(OMNIVERSE-PHYSX-SDK_DEBUG_LIBS_DIR "${z_kmpkg_omniverse_physx_sdk_prefix}/debug/lib" ABSOLUTE)
    get_filename_component(OMNIVERSE-PHYSX-SDK_RELEASE_BIN_DIR "${z_kmpkg_omniverse_physx_sdk_prefix}/bin" ABSOLUTE)
    get_filename_component(OMNIVERSE-PHYSX-SDK_DEBUG_BIN_DIR "${z_kmpkg_omniverse_physx_sdk_prefix}/debug/bin" ABSOLUTE)
    get_filename_component(OMNIVERSE-PHYSX-SDK_RELEASE_TOOLS_DIR "${z_kmpkg_omniverse_physx_sdk_prefix}/tools" ABSOLUTE)
    ...
    if (WIN32 AND KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
