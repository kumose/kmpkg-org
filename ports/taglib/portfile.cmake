...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/taglib)

set(pcfile "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/taglib.pc")
if(EXISTS "${pcfile}")
    kmpkg_replace_string("${pcfile}" "Requires: " "Requires: zlib" IGNORE_UNCHANGED)
    kmpkg_replace_string("${pcfile}" " -lz" "")
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL static)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/taglib/taglib_export.h" "defined(TAGLIB_STATIC)" "1")
