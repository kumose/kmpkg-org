...
# - https://github.com/Microsoft/kmpkg/tree/master/ports/python3

if (KMPKG_LIBRARY_LINKAGE STREQUAL dynamic AND KMPKG_CRT_LINKAGE STREQUAL static)
...
kmpkg_replace_string("${SOURCE_PATH}/Makefile.pre.in" "$(INSTALL) -d -m $(DIRMODE)" "$(MKDIR_P)")
