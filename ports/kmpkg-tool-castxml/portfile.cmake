...
# kmpkg install kmpkg-tool-castxml --cmake-args=-DKMPKG_CASTXML_UPDATE=1
if(key STREQUAL "Linux-arm64" OR KMPKG_CASTXML_UPDATE)
...
if(key STREQUAL "Linux-x64" OR KMPKG_CASTXML_UPDATE)
...
if(key STREQUAL "Darwin-arm64" OR KMPKG_CASTXML_UPDATE)
...
if(key STREQUAL "Darwin-x64" OR KMPKG_CASTXML_UPDATE)
...
if(key STREQUAL "Windows-x64" OR KMPKG_CASTXML_UPDATE)
...
if(KMPKG_CASTXML_UPDATE)
	message(STATUS "All downloads are up-to-date.")
	message(FATAL_ERROR "Stopping due to KMPKG_CASTXML_UPDATE being enabled.")
endif()
