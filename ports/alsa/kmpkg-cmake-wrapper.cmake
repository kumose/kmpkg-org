find_path(
  ...
  PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/include"
  NO_DEFAULT_PATH
)
...
find_library(
  ALSA_LIBRARY_DEBUG
  NAMES asound
  PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib"
  NO_DEFAULT_PATH
)
...
find_library(
  ...
  NAMES asound
  PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib"
  NO_DEFAULT_PATH
)
...
if(TARGET ALSA::ALSA)
  ...
  find_library(Z_KMPKG_HAS_LIBM NAMES m)
  if(Z_KMPKG_HAS_LIBM)
  ...
  find_library(Z_KMPKG_HAS_LIBRT NAMES rt)
  if(Z_KMPKG_HAS_LIBRT)
