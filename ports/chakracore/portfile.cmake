...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    if(KMPKG_TARGET_ARCHITECTURE MATCHES "x64")
    ...
    if(NOT DEFINED KMPKG_BUILD_TYPE)
        ...
        execute_process(
            COMMAND bash "build.sh" "--arch=${CHAKRACORE_TARGET_ARCH}" "--debug" "-j=${KMPKG_CONCURRENCY}"
    ...
    execute_process(
        COMMAND bash "build.sh" "--arch=${CHAKRACORE_TARGET_ARCH}" "-j=${KMPKG_CONCURRENCY}"
        WORKING_DIRECTORY "${SOURCE_PATH}"
        OUTPUT_VARIABLE CHAKRA_BUILD_SH_OUT
        ERROR_VARIABLE CHAKRA_BUILD_SH_ERR
        RESULT_VARIABLE CHAKRA_BUILD_SH_RES
...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
        ...
        kmpkg_copy_tools(TOOL_NAMES ch
