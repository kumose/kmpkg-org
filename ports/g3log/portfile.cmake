...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" G3_SHARED_LIB)
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "dynamic" G3_SHARED_RUNTIME)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/g3log)
