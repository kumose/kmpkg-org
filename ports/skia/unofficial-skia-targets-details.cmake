...
if("@has_location@")
    ...
    if("@not_executable@")
        ...
        z_kmpkg_@PORT@_get_link_libraries(z_kmpkg_@PORT@_link_libs "@cmake_build_type@" "@interface_link_libs@")
        set_property(TARGET @cmake_target@ APPEND PROPERTY INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:\$<@cmake_config_genex@:${z_kmpkg_@PORT@_link_libs}>>")
        unset(z_kmpkg_@PORT@_link_libs)
    endif()
endif()
