...
# Ensure that git is found within CMakeLists.txt by appending kmpkg's git executable dirpath to $PATH.
...
kmpkg_add_to_path("${GIT_EXE_PATH}")

set(OPTIONS)
if (KMPKG_TARGET_IS_OSX AND KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    set(OPTIONS "-DARCH=${KMPKG_TARGET_ARCHITECTURE}")
endif()
