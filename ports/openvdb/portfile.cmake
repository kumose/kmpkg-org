...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" OPENVDB_STATIC)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" OPENVDB_SHARED)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/OpenVDB)
...
if (OPENVDB_BUILD_TOOLS)
    kmpkg_copy_tools(TOOL_NAMES vdb_print vdb_render vdb_view vdb_lod AUTO_CLEAN)
endif()

if (NANOVDB_BUILD_TOOLS)
    kmpkg_copy_tools(TOOL_NAMES nanovdb_convert nanovdb_print nanovdb_validate AUTO_CLEAN)
endif()
