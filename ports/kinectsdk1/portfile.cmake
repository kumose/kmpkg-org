...
elseif(KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
    ...
    message(FATAL_ERROR "This port does not currently support architecture: ${KMPKG_TARGET_ARCHITECTURE}")
endif()

kmpkg_download_distfile(KINECTSDK10_INSTALLER
...
kmpkg_find_acquire_program(DARK)
...
file(REMOVE_RECURSE "${CURRENT_BUILDTREES_DIR}/src/KinectSDK-${KINECTSDK10_VERSION}-${KMPKG_TARGET_ARCHITECTURE}")
set(KINECTSDK10_MSI_INSTALLER "installer\\wix\\AttachedContainer\\KinectSDK-${KINECTSDK10_VERSION}-${KMPKG_TARGET_ARCHITECTURE}.msi")
kmpkg_execute_required_process(
    COMMAND
        "${LESSMSI}"
        x
...
set(KINECTSDK10_DIR "${CURRENT_BUILDTREES_DIR}/src/KinectSDK-${KINECTSDK10_VERSION}-${KMPKG_TARGET_ARCHITECTURE}/SourceDir/Microsoft SDKs/Kinect/${KINECTSDK10_VERSION}")
