if(KMPKG_TARGET_IS_XBOX)
    ...
    set(KMPKG_POLICY_SKIP_COPYRIGHT_CHECK enabled)
    ...
    if(KMPKG_TARGET_IS_MINGW)
        ...
        kmpkg_cmake_configure(SOURCE_PATH "${CURRENT_BUILDTREES_DIR}/fixlib")

        kmpkg_cmake_install()

        set(LIB_NAME "libGameInput.a")
    else()
        file(INSTALL "${PACKAGE_PATH}/native/lib/${KMPKG_TARGET_ARCHITECTURE}/gameinput.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
        file(INSTALL "${PACKAGE_PATH}/native/lib/${KMPKG_TARGET_ARCHITECTURE}/gameinput.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
