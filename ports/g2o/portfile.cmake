...
kmpkg_download_distfile(FIX_UPSTREAM_37d17a9
...
kmpkg_download_distfile(FIX_UPSTREAM_100af05
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" BUILD_LGPL_SHARED_LIBS)

kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        spdlog      G2O_USE_LOGGING
        spdlog      KMPKG_LOCK_FIND_PACKAGE_spdlog
)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_QGLViewer=OFF
    MAYBE_UNUSED_VARIABLES
        KMPKG_LOCK_FIND_PACKAGE_spdlog
)
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/g2o")

if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    file(GLOB_RECURSE HEADERS "${CURRENT_PACKAGES_DIR}/include/*")
    foreach(HEADER IN LISTS HEADERS)
        kmpkg_replace_string("${HEADER}" "#ifdef G2O_SHARED_LIBS" "#if 1" IGNORE_UNCHANGED)
    endforeach()
endif()
