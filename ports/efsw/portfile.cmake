...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" EFSW_BUILD_SHARED_LIB)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" EFSW_BUILD_STATIC_LIB)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/efsw)
