# NOTE: We don't use kmpkg_from_github as it does not
...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    kmpkg_check_linkage(ONLY_DYNAMIC_LIBRARY) # only DLL build rules
    ...
    string(APPEND KMPKG_C_FLAGS " /DUNICODE /D_UNICODE /D_WINSOCK_DEPRECATED_NO_WARNINGS")
    string(APPEND KMPKG_CXX_FLAGS " /DUNICODE /D_UNICODE /D_WINSOCK_DEPRECATED_NO_WARNINGS")
    ...
    kmpkg_copy_tools(TOOL_NAMES pluginviewer sasldblistusers2 saslpasswd2 testsuite AUTO_CLEAN)
    ...
    block(SCOPE_FOR VARIABLES)
        ...
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libsasl2.pc" " -lsasl2" " -llibsasl")
