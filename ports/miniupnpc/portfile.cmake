...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" MINIUPNPC_BUILD_SHARED)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" MINIUPNPC_BUILD_STATIC)
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    ...
    if(${RELEASE_TOOLS})
        kmpkg_copy_tools(TOOL_NAMES ${RELEASE_TOOLS} AUTO_CLEAN)
    endif()
endif()
