...
kmpkg_cmake_configure(SOURCE_PATH "${SOURCE_PATH}" OPTIONS -DBUILD_TESTS=OFF)

kmpkg_cmake_install()

kmpkg_cmake_config_fixup() # removes /debug/share
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include") # removes debug/include

kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/LICENSE") # Install License
