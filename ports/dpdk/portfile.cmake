if(KMPKG_TARGET_IS_LINUX AND KMPKG_HOST_IS_LINUX)
  execute_process(
...
if("docs" IN_LIST FEATURES)
  ...
  kmpkg_find_acquire_program(DOXYGEN)
  list(APPEND PYTHON_PACKAGES packaging sphinx)
endif()
if(PYTHON_PACKAGES)
  x_kmpkg_get_python_packages(OUT_PYTHON_VAR PYTHON3 PYTHON_VERSION "3" PACKAGES ${PYTHON_PACKAGES})
endif()
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/license/README")
