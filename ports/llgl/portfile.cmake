kmpkg_download_distfile(INSTALL_PATCH
...
kmpkg_download_distfile(ADD_CSTDINT_PATCH
...
if(KMPKG_TARGET_IS_IOS OR KMPKG_TARGET_IS_ANDROID)
    set(maybe_unused "LLGL_BUILD_RENDERER_OPENGL")
else()
    set(maybe_unused "LLGL_BUILD_RENDERER_OPENGL_ES3")
endif()

string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" LLGL_BUILD_STATIC_LIB)
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/LLGL)
