...
if(KMPKG_TARGET_IS_LINUX OR KMPKG_TARGET_IS_OSX OR KMPKG_TARGET_IS_WINDOWS)
...
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/gdk-pixbuf-2.0.pc" [[${bindir}]] "\${prefix}/tools/${PORT}")
if(NOT KMPKG_BUILD_TYPE)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/gdk-pixbuf-2.0.pc" [[${bindir}]] "\${prefix}/../tools/${PORT}")
endif()
...
# kmpkg-meson cross-build configuration differs from KMPKG_CROSSCOMPILING
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/gdk-pixbuf-thumbnailer${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
