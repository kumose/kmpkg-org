kmpkg_download_distfile(fgPlatformDestroyContext_PATCH
...
elseif(NOT KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_ANDROID)
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" FREEGLUT_STATIC)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" FREEGLUT_DYNAMIC)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DINSTALL_PDB=OFF # Installing pdbs failed on debug static. So, disable it and let kmpkg_copy_pdbs() do it
)
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/FreeGLUT)
kmpkg_fixup_pkgconfig()

file(GLOB pc_files "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/*.pc"  "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/*.pc")
foreach(file IN LISTS pc_files)
    kmpkg_replace_string("${file}" ";-D" " -D" IGNORE_UNCHANGED)
endforeach()
...
if(NOT KMPKG_TARGET_IS_ANDROID)
    ...
    if(NOT KMPKG_BUILD_TYPE)
        if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
            kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/glut.pc" " -lfreeglut" " -lfreeglutd" IGNORE_UNCHANGED)
        endif()
...
file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/kmpkg-cmake-wrapper.cmake" DESTINATION "${CURRENT_PACKAGES_DIR}/share/glut")
