...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" DISABLE_INSTALL_STATIC)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" DISABLE_INSTALL_SHARED)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/LibCDS)
