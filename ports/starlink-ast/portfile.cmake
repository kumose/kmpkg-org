...
# Avoid kmpkg artifact issues with symlinks
foreach(ast_lib IN ITEMS "${CURRENT_PACKAGES_DIR}/lib/libast" "${CURRENT_PACKAGES_DIR}/debug/lib/libast")
    if(KMPKG_LIBRARY_LINKAGE STREQUAL "static" AND EXISTS "${ast_lib}${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
        file(REMOVE "${ast_lib}_pass2${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
        file(COPY_FILE "${ast_lib}${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}" "${ast_lib}_pass2${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
    endif()
endforeach()
