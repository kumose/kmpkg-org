...
if(KMPKG_CROSSCOMPILING AND EXISTS "${CURRENT_HOST_INSTALLED_DIR}/manual-tools/${PORT}/save_linker_opts${KMPKG_HOST_EXECUTABLE_SUFFIX}")
    kmpkg_list(APPEND options "-DWITH_SAVE_LINKER_OPTS=${CURRENT_HOST_INSTALLED_DIR}/manual-tools/${PORT}/save_linker_opts${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()

string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" BUILD_STATIC)
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" STATIC_MSVCRT)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-DWITH_PROTOC=${CURRENT_HOST_INSTALLED_DIR}/tools/protobuf/protoc${KMPKG_HOST_EXECUTABLE_SUFFIX}"
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-mysql-connector-cpp)
...
if(NOT KMPKG_CROSSCOMPILING AND EXISTS "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/libutils/save_linker_opts${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
    kmpkg_copy_tools(TOOL_NAMES save_linker_opts
...
if(BUILD_STATIC)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/mysqlx/common/api.h" "defined STATIC_CONCPP" "(1)")
    if(WITH_JDBC)
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/jdbc/cppconn/build_config.h" "ifdef STATIC_CONCPP" "if 1")
    endif()
endif()
