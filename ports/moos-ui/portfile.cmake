...
kmpkg_copy_tool_dependencies("${CURRENT_PACKAGES_DIR}/tools/MOOS") 

file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin" "${CURRENT_PACKAGES_DIR}/debug")

file(WRITE "${CURRENT_PACKAGES_DIR}/include/fake_header_ui.h" "// fake header to pass kmpkg post install check \n")
