...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
  ...
  string(APPEND KMPKG_C_FLAGS " -DNGSTATIC_BUILD")
  string(APPEND KMPKG_CXX_FLAGS " -DNGSTATIC_BUILD")
endif()

if(KMPKG_CROSSCOMPILING)
  list(APPEND OPTIONS "-DMAKERLS_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/${PORT}/makerls${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/netgen)
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/LICENSE")

if(NOT KMPKG_CROSSCOMPILING)
  kmpkg_copy_tools(TOOL_NAMES makerls AUTO_CLEAN)
endif()
...
if(USE_OCC)
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/nglib.h" "define NGLIB\n" "define NGLIB\n#define OCCGEOMETRY\n")
endif()
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/nglib.h" "defined(NGSTATIC_BUILD)" "1")
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/core/ngcore_api.hpp" "!defined(NGSTATIC_BUILD)" "0")
endif()
...
if(NOT KMPKG_BUILD_TYPE)
  ...
  string(REPLACE [[optimized;${KMPKG_IMPORT_PREFIX}$<$<CONFIG:DEBUG>:/debug>/lib/]] [[optimized;${KMPKG_IMPORT_PREFIX}/lib/]] contents "${contents}")
  string(REPLACE [[debug;${KMPKG_IMPORT_PREFIX}/debug$<$<CONFIG:DEBUG>:/debug>/lib/]] [[debug;${KMPKG_IMPORT_PREFIX}/debug/lib/]] contents "${contents}")
endif()
...
if("python" IN_LIST FEATURES)
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/${PYTHON3_SITE}/netgen/config.py" "CMAKE_INSTALL_PREFIX  = \"${CURRENT_PACKAGES_DIR}" "CMAKE_INSTALL_PREFIX_NOT_USABLE = \"")
  if(NOT KMPKG_BUILD_TYPE)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/${PYTHON3_SITE}/netgen/config.py" "CMAKE_INSTALL_PREFIX  = \"${CURRENT_PACKAGES_DIR}" "CMAKE_INSTALL_PREFIX_NOT_USABLE = \"")
  endif()
endif()
