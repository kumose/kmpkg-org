...
file(GLOB RELEASE_LIB_FILES "${PACKAGE_PATH}/build/native/release/lib/${KMPKG_TARGET_ARCHITECTURE}/*.lib")
file(INSTALL ${RELEASE_LIB_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/lib/")

file(GLOB RELEASE_DLL_FILES "${PACKAGE_PATH}/build/native/release/bin/${KMPKG_TARGET_ARCHITECTURE}/*.dll")
file(INSTALL ${RELEASE_DLL_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/bin/")

if(NOT DEFINED KMPKG_BUILD_TYPE)
    file(GLOB DEBUG_LIB_FILES "${PACKAGE_PATH}/build/native/debug/lib/${KMPKG_TARGET_ARCHITECTURE}/*.lib")
    file(INSTALL ${DEBUG_LIB_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib/")

    file(GLOB DEBUG_DLL_FILES "${PACKAGE_PATH}/build/native/debug/bin/${KMPKG_TARGET_ARCHITECTURE}/*.dll")
    file(INSTALL ${DEBUG_DLL_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin/")
endif()

file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/usage" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
kmpkg_install_copyright(FILE_LIST "${PACKAGE_PATH}/LICENSE.txt")
