...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" SIMAGE_BUILD_SHARED_LIBS)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" SIMAGE_USE_STATIC_LIBS)
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" SIMAGE_USE_MSVC_STATIC_RUNTIME)
...
if(KMPKG_TARGET_IS_WINDOWS AND "gdiplus" IN_LIST FEATURES)
...
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/simage-${VERSION})

if (NOT KMPKG_TARGET_IS_WINDOWS OR KMPKG_TARGET_IS_MINGW)
    kmpkg_copy_tools(TOOL_NAMES simage-config AUTO_CLEAN)
endif()
