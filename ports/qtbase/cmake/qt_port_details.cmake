...
## 6. The build should fail with "Done downloading version and emitting hashes." This will have changed out the kmpkg.json versions of the qt ports and rewritten qt_port_data.cmake
...
if(QT_UPDATE_VERSION)
    ...
    set(KMPKG_USE_HEAD_VERSION 1)
    set(msg "" CACHE INTERNAL "")
    foreach(qt_port IN LISTS QT_PORTS)
        set(port_json "${CMAKE_CURRENT_LIST_DIR}/../../${qt_port}/kmpkg.json")
