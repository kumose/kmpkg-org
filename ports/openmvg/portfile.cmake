...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        opencv      KMPKG_LOCK_FIND_PACKAGE_OpenCV
        openmp      OpenMVG_USE_OPENMP
        software    OpenMVG_BUILD_SOFTWARES
        software    OpenMVG_BUILD_GUI_SOFTWARES
)

string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" OpenMVG_BUILD_SHARED)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_cereal=ON
        -DKMPKG_LOCK_FIND_PACKAGE_Ceres=ON
        -DKMPKG_LOCK_FIND_PACKAGE_Eigen3=ON
        -DKMPKG_LOCK_FIND_PACKAGE_Flann=ON
        -DKMPKG_LOCK_FIND_PACKAGE_JPEG=ON
        -DKMPKG_LOCK_FIND_PACKAGE_PNG=ON
        -DKMPKG_LOCK_FIND_PACKAGE_TIFF=ON
    OPTIONS_DEBUG
    ...
    MAYBE_UNUSED_VARIABLES
        ...
        KMPKG_LOCK_FIND_PACKAGE_OpenCV
)
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/openMVG")
...
if("software" IN_LIST FEATURES)
    if(KMPKG_TARGET_IS_OSX)
        ...
        kmpkg_copy_tools(AUTO_CLEAN TOOL_NAMES
...
endforeach()
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/LICENSE" ${third_party_notices})
