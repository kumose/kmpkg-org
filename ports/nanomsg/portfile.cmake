...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" NN_STATIC_LIB)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/nanomsg-${NN_PACKAGE_VERSION})
...
if(NN_ENABLE_NANOCAT)
    kmpkg_copy_tools(TOOL_NAMES nanocat AUTO_CLEAN)
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static" OR NOT KMPKG_TARGET_IS_WINDOWS)
    kmpkg_replace_string(
        ${CURRENT_PACKAGES_DIR}/share/${PORT}/nanomsg-config.cmake
        "set_and_check(nanomsg_BINDIR \${KMPKG_IMPORT_PREFIX}/bin)"
        ""
        IGNORE_UNCHANGED
    )
endif()
