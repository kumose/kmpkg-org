...
if("ffmpeg" IN_LIST FEATURES)
    ...
    if(KMPKG_TARGET_IS_WINDOWS OR KMPKG_TARGET_IS_OSX OR KMPKG_TARGET_IS_ANDROID)
...
# alsa is not ready
if(NOT "ffmpeg" IN_LIST FEATURES AND NOT "gstreamer" IN_LIST FEATURES AND KMPKG_TARGET_IS_LINUX)
...
if("gstreamer" IN_LIST FEATURES AND KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/Qt6Multimedia/Qt6QGstreamerMediaPluginDependencies.cmake" "GStreamer\;FALSE\;\;\;;GStreamer\;FALSE\;\;App\;;GStreamer\;FALSE\;\;\;Gl" "GStreamer\;FALSE\;\;\;;GStreamer\;FALSE\;\;App\;;GStreamer\;FALSE\;\;\;Gl;EGL\;FALSE\;\;\;" IGNORE_UNCHANGED)
endif()
