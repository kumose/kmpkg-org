...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    foreach(vcxproj ${vcxprojs})
        ...
        if(NOT KMPKG_CRT_LINKAGE STREQUAL dynamic)
        ...
        if(NOT KMPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
    ...
    if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
        ...
        set(MP3LAME_LIB "libmp3lame${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
    else()
        set(OPTIONS --enable-shared=yes --enable-static=no)
        if(KMPKG_TARGET_IMPORT_LIBRARY_SUFFIX)
            set(MP3LAME_LIB "libmp3lame${KMPKG_TARGET_IMPORT_LIBRARY_SUFFIX}")
        else()
            set(MP3LAME_LIB "libmp3lame${KMPKG_TARGET_SHARED_LIBRARY_SUFFIX}")
        endif()
    endif()
