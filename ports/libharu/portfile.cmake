...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  set(KMPKG_BUILD_SHARED_LIBS ON)
  set(KMPKG_BUILD_STATIC_LIBS OFF)
else()
  set(KMPKG_BUILD_SHARED_LIBS OFF)
  set(KMPKG_BUILD_STATIC_LIBS ON)
endif()

kmpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        -DLIBHPDF_STATIC=${KMPKG_BUILD_STATIC_LIBS}
        -DLIBHPDF_SHARED=${KMPKG_BUILD_SHARED_LIBS}
)

kmpkg_cmake_install()

kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-libharu)
