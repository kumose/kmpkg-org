...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" PA_DLL_LINK_WITH_STATIC_RUNTIME)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" PA_BUILD_SHARED)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" PA_BUILD_STATIC)
...
elseif(KMPKG_TARGET_IS_IOS OR KMPKG_TARGET_IS_OSX)
    kmpkg_list(APPEND options
