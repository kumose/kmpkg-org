...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DCMAKE_DISABLE_FIND_PACKAGE_OpenSSL=${KMPKG_TARGET_IS_WINDOWS} # match dependencies
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_Libuv=${KMPKG_TARGET_IS_OSX} # match dependencies
    MAYBE_UNUSED_VARIABLES
        KMPKG_LOCK_FIND_PACKAGE_Libuv
)
...
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/ProtonCpp" PACKAGE_NAME "protoncpp" DO_NOT_DELETE_PARENT_CONFIG_PATH)
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/Proton" PACKAGE_NAME "proton")
