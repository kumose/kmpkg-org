...
kmpkg_check_features(OUT_FEATURE_OPTIONS unused
    FEATURES
...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    # kmpkg_build_nmake doesn't supply cmake's implicit link libraries
    ...
    if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
        ...
        kmpkg_replace_string("${outfile}" "Libs:" "Requires.private: ${requires_private}\nLibs.private: -liconv -lcharset\nLibs:")
        kmpkg_replace_string("${outfile}" "  -lm" " ")
    endif()
    ...
    foreach(makefile IN LISTS makefiles)
        kmpkg_replace_string("${makefile}" " -I$(top_builddir)/./src/headers/spatialite" " -I$(top_builddir)/./src/headers" IGNORE_UNCHANGED)
    endforeach()

    kmpkg_make_install()

    if(KMPKG_TARGET_IS_MINGW AND KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
