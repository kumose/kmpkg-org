...
foreach(GIT2_FEATURE ${FEATURES})
    ...
    elseif(GIT2_FEATURE STREQUAL "ssh")
        ...
        message(STATUS "See the overlay ports documentation at https://learn.microsoft.com/kmpkg/concepts/overlay-ports")
    endif()
endforeach()
...
if("tools" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES git2 AUTO_CLEAN)
endif()
