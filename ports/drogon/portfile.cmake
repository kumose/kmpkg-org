...
if(KMPKG_CROSSCOMPILING)
    set(DROGON_CTL_TOOL "${CURRENT_HOST_INSTALLED_DIR}/tools/drogon/drogon_ctl${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" BUILD_DROGON_SHARED)
...
# Fix CMake files
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/Drogon)

kmpkg_fixup_pkgconfig()

# Copy drogon_ctl
if("ctl" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES drogon_ctl AUTO_CLEAN)
endif()
