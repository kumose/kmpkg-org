...
# Don't change to kmpkg_from_github! The sources in the git repository (archives) are missing some files that are distributed inside releases.
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/glew)
# Skip check the required dependency opengl
kmpkg_fixup_pkgconfig(SKIP_CHECK)

# Burn-in CMake build config
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/GL/glew.h" "ifndef GLEW_NO_GLU" "if 0")
