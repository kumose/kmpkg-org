...
if((KMPKG_CROSSCOMPILING OR KMPKG_TARGET_IS_OSX) AND "$ENV{PKG_CONFIG}$ENV{PKG_CONFIG_LIBDIR}" STREQUAL "")
...
#   Every other feature options are made available if the dependency is available on kmpkg and if the plugin has managed to build during tests
#
...
kmpkg_configure_meson(
    ...
    OPTIONS
        ...
        -Dorc=disabled # gstreamer requires a specific version of orc which is not available in kmpkg
        -Dqt5=disabled
        -Dqt6=disabled
        # Common options
        -Dtests=disabled
    ...
    ADDITIONAL_BINARIES
        ...
        glslc='${CURRENT_HOST_INSTALLED_DIR}/tools/shaderc/glslc${KMPKG_HOST_EXECUTABLE_SUFFIX}'
)
...
if(NOT KMPKG_LIBRARY_LINKAGE STREQUAL "static") # AND tools
...
if(GST_BIN_TOOLS)
    kmpkg_copy_tools(TOOL_NAMES ${GST_BIN_TOOLS} AUTO_CLEAN)
endif()

if(GST_LIBEXEC_TOOLS)
    kmpkg_copy_tools(TOOL_NAMES ${GST_LIBEXEC_TOOLS} SEARCH_DIR "${CURRENT_PACKAGES_DIR}/libexec/gstreamer-1.0" AUTO_CLEAN)
endif()
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    ...
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/gstreamer-1.0/gst/gstconfig.h" "!defined(GST_STATIC_COMPILATION)" "0")
endif()
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/gstreamer-gl-1.0.pc")
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/gstreamer-gl-1.0.pc" [[-I${libdir}/gstreamer-1.0/include]] "")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/gstreamer-gl-1.0.pc")
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/gstreamer-gl-1.0.pc" [[-I${libdir}/gstreamer-1.0/include]] "")
endif()
