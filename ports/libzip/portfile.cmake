...
kmpkg_check_features(
    ...
    FEATURES
        ...
        liblzma         KMPKG_LOCK_FIND_PACKAGE_LibLZMA
        zstd            KMPKG_LOCK_FIND_PACKAGE_zstd
        # AES
        default-aes     ENABLE_COMMONCRYPTO
        default-aes     ENABLE_WINDOWS_CRYPTO
        openssl         ENABLE_OPENSSL
        openssl         KMPKG_LOCK_FIND_PACKAGE_OpenSSL
        mbedtls         ENABLE_MBEDTLS
        mbedtls         KMPKG_LOCK_FIND_PACKAGE_MbedTLS
)
...
kmpkg_cmake_configure(
    ...
    MAYBE_UNUSED_VARIABLES
        KMPKG_LOCK_FIND_PACKAGE_MbedTLS
        KMPKG_LOCK_FIND_PACKAGE_OpenSSL
)

kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/libzip")
