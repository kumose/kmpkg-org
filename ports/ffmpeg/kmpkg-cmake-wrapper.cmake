...
set(z_kmpkg_using_kmpkg_find_ffmpeg OFF)

# Detect targets created e.g. by VTK/CMake/FindFFMPEG.cmake
set(kmpkg_no_avcodec_target ON)
set(kmpkg_no_avformat_target ON)
set(kmpkg_no_avutil_target ON)
set(kmpkg_no_swresample_target ON)
if(TARGET FFmpeg::avcodec)
  set(kmpkg_no_avcodec_target OFF)
endif()
if(TARGET FFmpeg::avformat)
  set(kmpkg_no_avformat_target OFF)
endif()
if(TARGET FFmpeg::avutil)
  set(kmpkg_no_avutil_target OFF)
endif()
if(TARGET FFmpeg::swresample)
  set(kmpkg_no_swresample_target OFF)
endif()

_find_package(${ARGS})

# Fixup of variables and targets for (some) vendored find modules
if(NOT z_kmpkg_using_kmpkg_find_ffmpeg AND NOT "@BUILD_SHARED_LIBS@")
...
if(APPLE)
  ...
  if(PKG_libavcodec_LIBRARIES)
    ...
    if(kmpkg_no_avcodec_target AND TARGET FFmpeg::avcodec)
...
if(@WITH_XML2@)
  ...
  if(kmpkg_no_avformat_target AND TARGET FFmpeg::avformat)
...
if(@WITH_SOXR@)
  find_library(SOXR_LIBRARY_RELEASE NAMES soxr PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH)
  find_library(SOXR_LIBRARY_DEBUG   NAMES soxr PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH)
  ...
  if(kmpkg_no_swresample_target AND TARGET FFmpeg::swresample)
...
if(@WITH_MFX@)
  ...
  if(kmpkg_no_avutil_target AND TARGET FFmpeg::avutil)
...
unset(z_kmpkg_using_kmpkg_find_ffmpeg)

set(FFMPEG_LIBRARY ${FFMPEG_LIBRARIES})

set(CMAKE_MODULE_PATH ${FFMPEG_PREV_MODULE_PATH})

unset(kmpkg_no_avcodec_target)
unset(kmpkg_no_avformat_target)
unset(kmpkg_no_avutil_target)
unset(kmpkg_no_swresample_target)
