...
if(KMPKG_CROSSCOMPILING AND KMPKG_TARGET_IS_ANDROID)
    set(cross_flags "--with-udev=${CURRENT_HOST_INSTALLED_DIR}/lib/udev/"
                    "--enable-crossbuilddir=${CURRENT_INSTALLED_DIR}/lib/udev/"
                    "HOST_MTP_HOTPLUG=${CURRENT_HOST_INSTALLED_DIR}/tools/libmtp/bin/mtp-hotplug${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
