...
# We don't want to use the kmpkg dependency since it is broken in many
# environments - see https://github.com/microsoft/kmpkg/issues/14864. This
...
# Default flags
set(AF_DEFAULT_KMPKG_CMAKE_FLAGS
  -DBUILD_TESTING=OFF
  -DAF_BUILD_DOCS=OFF
...
if("cpu" IN_LIST FEATURES)
    if(KMPKG_TARGET_IS_WINDOWS AND KMPKG_CRT_LINKAGE STREQUAL "static")
      list(APPEND AF_DEFAULT_KMPKG_CMAKE_FLAGS "-DMKL_THREAD_LAYER=Sequential")
    endif()
    if(KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        list(APPEND AF_DEFAULT_KMPKG_CMAKE_FLAGS "-DINT_SIZE=8")
...
if (KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_LIBRARY_LINKAGE STREQUAL "static")
  set(AF_BIN_DIR ${CURRENT_PACKAGES_DIR})
  list(APPEND AF_DEFAULT_KMPKG_CMAKE_FLAGS "-DAF_BIN_DIR=${AF_BIN_DIR}")
endif()
...
if(NOT KMPKG_TARGET_IS_WINDOWS)
    kmpkg_cmake_config_fixup(CONFIG_PATH share/ArrayFire/cmake)
else()
