...
# that it always links to the release MSVC C runtime (CRT) and causes kmpkg's post-build CRT linkage check to fail for
...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    set(KMPKG_POLICY_SKIP_CRT_LINKAGE_CHECK enabled)
endif()
...
kmpkg_cmake_config_fixup(PACKAGE_NAME rerun_sdk CONFIG_PATH "lib/cmake/rerun_sdk")

file(GLOB LIBRERUN_C_FILE
    RELATIVE "${CURRENT_PACKAGES_DIR}/lib"
    "${CURRENT_PACKAGES_DIR}/lib/${KMPKG_TARGET_STATIC_LIBRARY_PREFIX}rerunc_c_-*${KMPKG_TARGET_STATIC_LIBRARY_SUFFIX}"
)
