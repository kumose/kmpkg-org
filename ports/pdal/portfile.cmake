...
file(WRITE "${SOURCE_PATH}/pdal/JsonFwd.hpp" "/* kmpkg redacted */\n#include <nlohmann/json_fwd.hpp>\nnamespace NL = nlohmann;\n")
file(MAKE_DIRECTORY "${SOURCE_PATH}/vendor/nlohmann/schema-validator")
file(WRITE "${SOURCE_PATH}/vendor/nlohmann/schema-validator/json-schema.hpp" "/* kmpkg redacted */\n#include <nlohmann/json-schema.hpp>\n")
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-DDIMBUILDER_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/manual-tools/pdal-dimbuilder/dimbuilder${KMPKG_HOST_EXECUTABLE_SUFFIX}"
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/PDAL)
...
kmpkg_copy_tools(TOOL_NAMES pdal AUTO_CLEAN)
...
kmpkg_install_copyright(FILE_LIST
