...
kmpkg_cmake_configure(
    ...
    OPTIONS
        -DENABLE_OFXCONNECT=OFF # depends on libxml++ ABI 2.6, while kmpkg ships ABI 4.0. See https://libxmlplusplus.github.io/libxmlplusplus/#abi-versions
        ${FEATURE_OPTIONS}
)

kmpkg_cmake_install()
kmpkg_fixup_pkgconfig()
kmpkg_cmake_config_fixup(PACKAGE_NAME LibOFX CONFIG_PATH lib/cmake/libofx)
kmpkg_copy_pdbs()

list(REMOVE_ITEM FEATURES core iconv)
if(FEATURES)
    kmpkg_copy_tools(TOOL_NAMES ${FEATURES} AUTO_CLEAN)
endif()
