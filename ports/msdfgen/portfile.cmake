...
kmpkg_cmake_configure(
    ...
    OPTIONS
        -DMSDFGEN_USE_KMPKG=ON
        -DMSDFGEN_KMPKG_FEATURES_SET=ON
        -DMSDFGEN_INSTALL=ON
        -DMSDFGEN_DYNAMIC_RUNTIME="${MSDFGEN_DYNAMIC_RUNTIME}"
        ${FEATURE_OPTIONS}
    MAYBE_UNUSED_VARIABLES
        MSDFGEN_KMPKG_FEATURES_SET
)

kmpkg_cmake_install()

kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/msdfgen)

# move exe to tools
if("tools" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES msdfgen AUTO_CLEAN)
endif()
