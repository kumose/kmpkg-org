...
if(buildtrees_path_length GREATER warning_length AND CMAKE_HOST_WIN32)
    message(WARNING "${PORT}'s buildsystem uses very long paths and may fail on your system.\n"
        "We recommend moving kmpkg to a short path such as 'C:\\kmpkg' or using the subst command."
    )
endif()
...
kmpkg_add_to_path("${CURRENT_HOST_INSTALLED_DIR}/tools/gdk-pixbuf")
kmpkg_add_to_path("${CURRENT_HOST_INSTALLED_DIR}/tools/gettext/bin")
...
foreach(dir IN ITEMS "${TARGET_TRIPLET}-dbg" "${TARGET_TRIPLET}-rel")
    if(EXISTS "${CURRENT_BUILDTREES_DIR}/${dir}/build.ninja")
        kmpkg_replace_string("${CURRENT_BUILDTREES_DIR}/${dir}/build.ninja" "/${dir}/../src/" "/src/")
    endif()
endforeach()
...
kmpkg_copy_tools(TOOL_NAMES ${GTK_TOOLS} AUTO_CLEAN)
