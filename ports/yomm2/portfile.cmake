...
if(KMPKG_LIBRARY_LINKAGE MATCHES "dynamic")
    set(YOMM2_SHARED ON)
endif()

if(KMPKG_LIBRARY_LINKAGE MATCHES "static")
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/YOMM2)

file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include")
if(KMPKG_LIBRARY_LINKAGE MATCHES "static") # header only library in static build
