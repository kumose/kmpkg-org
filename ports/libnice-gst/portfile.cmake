...
if(KMPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    ...
    if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "debug")
        ...
        if(KMPKG_TARGET_IS_WINDOWS AND EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/gstreamer-1.0/gstnice.pdb")
        ...
        file(APPEND "${USAGE_FILE}" "\t\t* '<path-to-kmpkg_installed>/${TARGET_TRIPLET}/debug/plugins/gstreamer/'\n")
    endif()
    if(NOT DEFINED KMPKG_BUILD_TYPE OR KMPKG_BUILD_TYPE STREQUAL "release")
        ...
        if(KMPKG_TARGET_IS_WINDOWS AND EXISTS "${CURRENT_PACKAGES_DIR}/lib/gstreamer-1.0/gstnice.pdb")
        ...
        file(APPEND "${USAGE_FILE}" "\t\t* '<path-to-kmpkg_installed>/${TARGET_TRIPLET}/plugins/gstreamer/'\n")
    endif()
else()
