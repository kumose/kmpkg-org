...
elseif(NOT TARGET_TRIPLET STREQUAL HOST_TRIPLET)
  ...
  elseif(KMPKG_TARGET_IS_LINUX AND KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
    ...
    message(WARNING
"Unable to cross-compile clapack for ${KMPKG_TARGET_ARCHITECTURE}-${KMPKG_CMAKE_SYSTEM_NAME}.
...
kmpkg_cmake_config_fixup(CONFIG_PATH share/clapack)

file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include")

# Install clapack wrappers.
file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/kmpkg-cmake-wrapper.cmake" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}/wrapper")
