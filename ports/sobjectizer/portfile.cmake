...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" SOBJECTIZER_BUILD_STATIC )
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" SOBJECTIZER_BUILD_SHARED)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/sobjectizer)
