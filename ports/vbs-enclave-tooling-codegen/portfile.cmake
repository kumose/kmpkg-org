...
kmpkg_find_acquire_program(NUGET)
...
set(RELEASE_BUILD_DIR "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/_build/${KMPKG_TARGET_ARCHITECTURE}/Release")
set(DEBUG_BUILD_DIR "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/_build/${KMPKG_TARGET_ARCHITECTURE}/Debug")
...
# is passed to kmpkg_msbuild_install. This is by design.
if (EXISTS "${RELEASE_BUILD_DIR}")
    kmpkg_copy_tools(TOOL_NAMES edlcodegen SEARCH_DIR "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/_build/x64/Release"  AUTO_CLEAN)
    file(GLOB CPP_SUPPORT_LIB_FILE "${RELEASE_BUILD_DIR}/veil_enclave_cpp_support_${KMPKG_TARGET_ARCHITECTURE}_Release_lib.lib")
...
if(EXISTS "${DEBUG_BUILD_DIR}")
    ...
    file(GLOB CPP_SUPPORT_LIB_FILE "${DEBUG_BUILD_DIR}/veil_enclave_cpp_support_${KMPKG_TARGET_ARCHITECTURE}_Debug_lib.lib")
