...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" STATICCRT)
...
kmpkg_cmake_configure(
    ...
    OPTIONS ${FEATURE_OPTIONS}
        -DWITH_WEBKIT3=OFF
        -DWITH_KDE=${KMPKG_TARGET_IS_LINUX}
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH share/cmake/Modules)
kmpkg_copy_pdbs()
kmpkg_fixup_pkgconfig()

kmpkg_copy_tools(TOOL_NAMES proxy AUTO_CLEAN)
