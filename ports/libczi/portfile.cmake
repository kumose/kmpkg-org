...
# Translate enabled kmpkg features into CMake -D flags:
...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" BUILD_SHARED_LIBCZI)

kmpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        ${FEATURE_OPTS}
        -DLIBCZI_DO_NOT_SET_MSVC_RUNTIME_LIBRARY=ON  # set by kmpkg
...
kmpkg_cmake_config_fixup(CONFIG_PATH share/libczi)
