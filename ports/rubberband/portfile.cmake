...
if(
    (KMPKG_TARGET_IS_WINDOWS AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "x86" OR KMPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64"))
    OR KMPKG_TARGET_IS_OSX
    OR KMPKG_TARGET_IS_IOS
    OR KMPKG_TARGET_IS_EMSCRIPTEN
)
    set(FFT_LIB "fftw")
else()
    set(FFT_LIB "sleef")
...
kmpkg_configure_meson(
    ...
    OPTIONS
        ...
        -Dlv2=disabled             # 'auto', 'disabled', 'enabled' lv2 feature is not yet supported yet because kmpkg can't isntall to 
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/rubberband-program${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
...
if("cli" IN_LIST FEATURES)
  kmpkg_copy_tools(TOOL_NAMES ${RUBBERBAND_PROGRAM_NAMES} AUTO_CLEAN)
endif()
