...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" HPX_WITH_STATIC_LINKING)
...
if(NOT KMPKG_TARGET_ARCHITECTURE MATCHES "(x64|x86)")
...
# post build cleanup
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/HPX)
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/hpxrun.py")
    ...
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/hpxrun.py" "'${CURRENT_INSTALLED_DIR}/tools/openmpi/bin/mpiexec'" "'mpiexec'" IGNORE_UNCHANGED)
endif()
