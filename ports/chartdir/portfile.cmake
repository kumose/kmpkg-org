...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_download_distfile(ARCHIVE_FILE
        URLS "https://www.advsofteng.com/kmpkg/chartdir_cpp_win_7.0.0.zip"
...
elseif(KMPKG_TARGET_IS_OSX)
    ...
    kmpkg_download_distfile(ARCHIVE_FILE
        URLS "https://www.advsofteng.com/kmpkg/chartdir_cpp_mac_7.0.0.tar.gz"
...
elseif(KMPKG_TARGET_IS_LINUX)
    ...
    if(KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        ...
        kmpkg_download_distfile(ARCHIVE_FILE
            URLS "https://www.advsofteng.com/kmpkg/chartdir_cpp_linux_64_7.0.0.tar.gz"
        ...
        kmpkg_download_distfile(ARCHIVE_FILE
            URLS "https://www.advsofteng.com/kmpkg/chartdir_cpp_linux_7.0.0.tar.gz"
