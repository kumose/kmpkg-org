...
set(POPPLER_PC_REQUIRES "freetype2 libjpeg libopenjp2 libpng libtiff-4 poppler-kmpkg-iconv")

kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        cairo       WITH_Cairo
        cairo       KMPKG_LOCK_FIND_PACKAGE_CAIRO
        cms         ENABLE_LCMS
        cms         KMPKG_LOCK_FIND_PACKAGE_LCMS2
        curl        ENABLE_LIBCURL
        curl        KMPKG_LOCK_FIND_PACKAGE_CURL
        glib        ENABLE_GLIB
        glib        KMPKG_LOCK_FIND_PACKAGE_GLIB
        private-api ENABLE_UNSTABLE_API_ABI_HEADERS
        qt          ENABLE_QT6
        qt          KMPKG_LOCK_FIND_PACKAGE_Qt6
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_ECM=OFF
        -DKMPKG_LOCK_FIND_PACKAGE_GTK=OFF
        ${FEATURE_OPTIONS}
-DKMPKG_TRACE_FIND_PACKAGE=1
    MAYBE_UNUSED_VARIABLES
        GLIB2_MKENUMS_PYTHON
        KMPKG_LOCK_FIND_PACKAGE_CURL
        KMPKG_LOCK_FIND_PACKAGE_GLIB
        KMPKG_LOCK_FIND_PACKAGE_LCMS2
        KMPKG_LOCK_FIND_PACKAGE_CAIRO
        KMPKG_LOCK_FIND_PACKAGE_GTK
...
kmpkg_cmake_config_fixup(PACKAGE_NAME unofficial-poppler)

kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/poppler.pc" "Libs:" "Requires.private: ${POPPLER_PC_REQUIRES}\nLibs:")
if(NOT KMPKG_BUILD_TYPE)
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/poppler.pc" "Libs:" "Requires.private: ${POPPLER_PC_REQUIRES}\nLibs:")
endif()
