...
# Users may override with KMPKG_CMAKE_CONFIGURE_OPTIONS.
string(COMPARE EQUAL "${KMPKG_TARGET_ARCHITECTURE}" "x64" VXL_HAS_SSE2_HARDWARE_SUPPORT)
set(VCL_HAS_LFS ON)
if(KMPKG_TARGET_IS_WINDOWS)
    set(VCL_HAS_LFS OFF)
endif()
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH share/vxl/cmake)
kmpkg_copy_pdbs()
...
if("openjpeg" IN_LIST FEATURES)
    ...
    kmpkg_list(APPEND file_list "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/openjpeg2 license.txt")
endif()
kmpkg_install_copyright(FILE_LIST ${file_list} COMMENT [[
