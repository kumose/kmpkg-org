...
elseif (KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    ...
    message(FATAL_ERROR "Unsupported architecture: ${KMPKG_TARGET_ARCHITECTURE}")
endif()
...
kmpkg_download_distfile(GNI_TO_CMAKE_PY
...
x_kmpkg_get_python_packages(PYTHON_VERSION "3" OUT_PYTHON_VAR "PYTHON3" PACKAGES ply)
...
kmpkg_download_distfile(WK_ANGLE_INCLUDE_CMAKELISTS
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-DKMPKG_TARGET_IS_WINDOWS=${KMPKG_TARGET_IS_WINDOWS}"
        "-DUSE_METAL=${USE_METAL}"
)

kmpkg_cmake_install()

kmpkg_cmake_config_fixup(CONFIG_PATH share/unofficial-angle PACKAGE_NAME unofficial-angle)
