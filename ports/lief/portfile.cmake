...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        # Build with external kmpkg dependencies
        ...
        "-DLIEF_EXTERNAL_SPAN_DIR=${_KMPKG_INSTALLED_DIR}/${TARGET_TRIPLET}/include/tcb"
)

kmpkg_cmake_install()

kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/LIEF")

kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/lief/LIEFConfig.cmake"
