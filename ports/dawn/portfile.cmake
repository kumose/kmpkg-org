if (KMPKG_TARGET_IS_EMSCRIPTEN)
    ...
    kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/webgpu/src/LICENSE" "${SOURCE_PATH}/webgpu_cpp/LICENSE")
...
set(KMPKG_LIBRARY_LINKAGE_BACKUP ${KMPKG_LIBRARY_LINKAGE})
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/Dawn)
...
if (KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW AND NOT KMPKG_TARGET_IS_UWP)
...
set(KMPKG_LIBRARY_LINKAGE ${KMPKG_LIBRARY_LINKAGE_BACKUP})
