...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DALSOFT_BACKEND_OPENSL=${KMPKG_TARGET_IS_ANDROID}
        -DALSOFT_REQUIRE_OPENSL=${KMPKG_TARGET_IS_ANDROID}
...
kmpkg_cmake_install()
kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/OpenAL")
kmpkg_fixup_pkgconfig()

if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    foreach(HEADER IN ITEMS al.h alc.h)
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/AL/${HEADER}" "defined(AL_LIBTYPE_STATIC)" "1")
    endforeach()
endif()
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/COPYING" "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/pffft Notice")