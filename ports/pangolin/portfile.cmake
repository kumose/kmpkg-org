...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" MSVC_USE_STATIC_CRT)
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/Pangolin)
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/pangolin/PangolinConfig.cmake" "Pangolin_CMAKEMODULES ${SOURCE_PATH}/" "Pangolin_CMAKEMODULES \${CMAKE_CURRENT_LIST_DIR}/")
...
if("tools" IN_LIST FEATURES)
    kmpkg_copy_tools(TOOL_NAMES Plotter VideoConvert VideoJsonPrint VideoJsonTransform VideoViewer AUTO_CLEAN)
endif()
...
# Put the license file where kmpkg expects it
