...
if(KMPKG_TARGET_IS_WINDOWS)
    set(KMPKG_C_FLAGS "${KMPKG_C_FLAGS} -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS")
    set(KMPKG_CXX_FLAGS "${KMPKG_CXX_FLAGS} -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS")
endif()

if(KMPKG_TARGET_IS_WINDOWS AND KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    set(KMPKG_C_FLAGS "${KMPKG_C_FLAGS} -DBUILD_AS_WINDOWS_STATIC_LIBARAY")
    set(KMPKG_CXX_FLAGS "${KMPKG_CXX_FLAGS} -DBUILD_AS_WINDOWS_STATIC_LIBARAY")
endif()
...
if(KMPKG_CROSSCOMPILING)
    kmpkg_add_to_path(PREPEND "${CURRENT_HOST_INSTALLED_DIR}/tools/libmagic/bin")
elseif(KMPKG_TARGET_IS_WINDOWS AND KMPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    set(EXTRA_ARGS "ADD_BIN_TO_PATH")
endif()

kmpkg_install_make(${EXTRA_ARGS})
