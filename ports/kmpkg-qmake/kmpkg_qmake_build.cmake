...
function(kmpkg_qmake_build)
    ...
    kmpkg_backup_env_variables(VARS PATH LD_LIBRARY_PATH)

    if(CMAKE_HOST_WIN32)
        if (KMPKG_QMAKE_USE_NMAKE)
    ...
    foreach(build_type IN ITEMS ${items})
        ...
        if(NOT arg_SKIP_MAKEFILES)
            ...
            z_kmpkg_qmake_fix_makefiles("${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-${short_name_${build_type}}")
        endif()
