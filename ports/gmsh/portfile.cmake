...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" BUILD_LIB)
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        # Requies dependencies which not included in kmpkg yet
        -DENABLE_3M=OFF
        -DENABLE_ALGLIB=OFF
        -DENABLE_ANN=OFF
        -DENABLE_BAMG=OFF
        ...
        -DENABLE_RPATH=OFF # Should use dependencies in kmpkg
        -DENABLE_TESTS=OFF
)

kmpkg_cmake_install()

kmpkg_copy_tools(TOOL_NAMES gmsh AUTO_CLEAN)
