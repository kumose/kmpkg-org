...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" BUILD_PLUGINS_STATIC)

set(ALL_SUPPORTED_FEATURES ${ALL_FEATURES})

# Head only features
if(NOT KMPKG_USE_HEAD_VERSION)
...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES ${_COMPONENTS})

if(KMPKG_CROSSCOMPILING)
    set(CORRADE_RC_EXECUTABLE "-DCORRADE_RC_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/corrade/corrade-rc${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
...
# Copy tools into kmpkg's tools directory
...
if(_TOOL_EXEC_NAMES)
    kmpkg_copy_tools(TOOL_NAMES ${_TOOL_EXEC_NAMES} AUTO_CLEAN)
endif()
...
#
# See https://github.com/microsoft/kmpkg/pull/1235#issuecomment-308805989 for 
# futher info.
