...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" USE_STATIC_RT)

SET(options "")
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_CMAKE_CONFIGURE_OPTIONS MATCHES "Packet_ROOT")
...
and pass '-DPacket_ROOT=<path of SDK>' via KMPKG_CMAKE_CONFIGURE_OPTIONS
