...
kmpkg_find_acquire_program(PYTHON2)
...
kmpkg_add_to_path(PREPEND "${GIT_PATH}")
kmpkg_add_to_path(PREPEND "${PYTHON2_PATH}")
kmpkg_add_to_path(PREPEND "${GN_PATH}")
kmpkg_add_to_path(PREPEND "${NINJA_PATH}")
if(KMPKG_TARGET_IS_WINDOWS)
  kmpkg_acquire_msys(MSYS_ROOT PACKAGES pkg-config)
  kmpkg_add_to_path("${MSYS_ROOT}/usr/bin")
endif()

set(KMPKG_KEEP_ENV_VARS PATH;DEPOT_TOOLS_WIN_TOOLCHAIN)
...
kmpkg_gn_configure(
    ...
    OPTIONS "is_component_build=${is_component_build} target_cpu=\"${KMPKG_TARGET_ARCHITECTURE}\" v8_monolithic=${v8_monolithic} v8_use_external_startup_data=${v8_use_external_startup_data} use_sysroot=false is_clang=false use_custom_libcxx=false v8_enable_verify_heap=false icu_use_data_file=false" 
...
kmpkg_fixup_pkgconfig(SYSTEM_LIBRARIES m dl pthread Winmm DbgHelp v8_libbase v8_libplatform v8)
