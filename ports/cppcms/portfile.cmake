...
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" DISABLE_SHARED)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" DISABLE_STATIC)
...
endforeach()
kmpkg_copy_tools(TOOL_NAMES cppcms_scale cppcms_make_key cppcms_config_find_param AUTO_CLEAN)

file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include")

kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/MIT.TXT" "${SOURCE_PATH}/THIRD_PARTY_SOFTWARE.TXT")
