string(FIND ";${ARGS};" ";CONFIG;" z_kmpkg_opencl_config)
_find_package(${ARGS})
if("@KMPKG_LIBRARY_LINKAGE@" STREQUAL "static" AND (NOT CMAKE_SYSTEM_NAME MATCHES "Darwin") AND z_kmpkg_opencl_config EQUAL "-1")
