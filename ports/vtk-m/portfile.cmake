...
# TODO: Should be replaced in the future with KMPKG internal versions
...
if("cuda" IN_LIST FEATURES)
    ...
    list(APPEND OPTIONS
        ...
        -DCMAKE_CUDA_ARCHITECTURES=all-major # override with KMPKG_CMAKE_CONFIGURE_OPTIONS
    )
    if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        message(STATUS "Feature CUDA forces static build!")
    endif()
    set(KMPKG_LIBRARY_LINKAGE "static") # CUDA forces static build.
endif()
...
kmpkg_from_gitlab(GITLAB_URL "https://gitlab.kitware.com" 
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/vtkm-2.3" PACKAGE_NAME vtkm-2.3)
kmpkg_fixup_pkgconfig()

kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/vtkm-2.3/VTKmConfig.cmake" "${CURRENT_BUILDTREES_DIR}" ":not/existing/buildtree:")
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/vtkm-2.3/VTKmConfig.cmake" [[/lib/cmake/vtkm-2.3"]] [[/share/vtkm-2.3"]])
