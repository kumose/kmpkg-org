...
if(KMPKG_TARGET_IS_WINDOWS AND NOT (KMPKG_TARGET_IS_XBOX OR KMPKG_TARGET_IS_MINGW) AND NOT "dx12" IN_LIST FEATURES)
  list(APPEND EXTRA_OPTIONS "-DCMAKE_DISABLE_FIND_PACKAGE_directx-headers=TRUE")
endif()

if(KMPKG_TARGET_IS_MINGW AND ("dx11" IN_LIST FEATURES))
...
kmpkg_cmake_config_fixup(CONFIG_PATH share/directxtex)

if("tools" IN_LIST FEATURES)

  file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/tools/directxtex/")

  if((KMPKG_TARGET_ARCHITECTURE STREQUAL x64) AND (NOT (("openexr" IN_LIST FEATURES) OR ("xbox" IN_LIST FEATURES))))
  ...
  elseif(((KMPKG_TARGET_ARCHITECTURE STREQUAL arm64) OR (KMPKG_TARGET_ARCHITECTURE STREQUAL arm64ec)) AND (NOT ("openexr" IN_LIST FEATURES)))
