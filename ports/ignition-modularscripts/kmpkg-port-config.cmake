include("${CMAKE_CURRENT_LIST_DIR}/../kmpkg-cmake/kmpkg-port-config.cmake")
include("${CMAKE_CURRENT_LIST_DIR}/../kmpkg-cmake-config/kmpkg-port-config.cmake")
...
function(ignition_modular_build_library)
    ...
    if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/cmake")
        ...
        # with name ${IML_CMAKE_PACKAGE_NAME}-${COMPONENT_NAME}, so it is needed to call kmpkg_cmake_config_fixup for them as well
        ...
        foreach(COMPONENT_CMAKE_PACKAGE_NAME IN LISTS COMPONENTS_CMAKE_PACKAGE_NAMES)
            kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/${COMPONENT_CMAKE_PACKAGE_NAME}"
...
##
## ### SHA512
## The SHA512 hash that should match the downloaded  archive. This is forwarded to the `kmpkg_from_github` command.
##
## ### REF
## Reference to the tag of the desired release. This is forwarded to the `kmpkg_from_github` command.
## If not specified, defaults to `ignition-${NAME}${MAJOR_VERSION}_${VERSION}`.
##
## ### HEAD_REF
## Reference (tag) to the desired release. This is forwarded to the `kmpkg_from_github` command.
## If not specified, defaults to `ign-${NAME}${MAJOR_VERSION}`.
##
## ### PATCHES
## A list of patches to be applied to the extracted sources.
## This is forwarded to the `kmpkg_from_github` command.
##
## ### CMAKE_PACKAGE_NAME
...
## ## Examples:
##
## * [ignition-cmake0](https://github.com/Microsoft/kmpkg/blob/master/ports/ignition-cmake0/portfile.cmake)
## * [ignition-math4](https://github.com/Microsoft/kmpkg/blob/master/ports/ignition-math4/portfile.cmake)
## * [ignition-fuel-tools1](https://github.com/Microsoft/kmpkg/blob/master/ports/ignition-fuel-tools1/portfile.cmake)
