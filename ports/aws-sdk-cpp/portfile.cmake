...
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "dynamic" FORCE_SHARED_CRT)
...
foreach(TARGET IN LISTS targets)
    ...
    kmpkg_cmake_config_fixup(PACKAGE_NAME "${package}" CONFIG_PATH "lib/cmake/aws-cpp-sdk-${TARGET}" DO_NOT_DELETE_PARENT_CONFIG_PATH)
endforeach()
kmpkg_cmake_config_fixup(PACKAGE_NAME "awssdk" CONFIG_PATH "lib/cmake/AWSSDK")
