...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "${MIMALLOC_CMAKE_DIR}/${MIMALLOC_VERSION_DIR}")
    set(MIMALLOC_INCLUDE_DIR "${KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/include")
    # As in kmpkg.cmake
    if(NOT DEFINED CMAKE_BUILD_TYPE OR CMAKE_BUILD_TYPE MATCHES "^[Dd][Ee][Bb][Uu][Gg]$")
        set(MIMALLOC_LIBRARY_DIR "${KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib")
    else()
        set(MIMALLOC_LIBRARY_DIR "${KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib")
    endif()
