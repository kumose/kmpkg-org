...
if(NOT TARGET unofficial::qwt::qwt)
    ...
    find_file(qwt_LIBRARY_RELEASE_DLL NAMES qwt.dll PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/bin" NO_DEFAULT_PATH)
    find_file(qwt_LIBRARY_DEBUG_DLL NAMES qwtd.dll PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/bin" NO_DEFAULT_PATH)
    ...
    if(EXISTS "${qwt_LIBRARY_RELEASE_DLL}")
        ...
        find_library(qwt_LIBRARY_RELEASE NAMES qwt PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH REQUIRED)
        ...
        if(EXISTS "${qwt_LIBRARY_DEBUG_DLL}")
            ...
            find_library(qwt_LIBRARY_DEBUG NAMES qwtd PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH REQUIRED)
        ...
        find_library(qwt_LIBRARY_RELEASE NAMES qwt PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH)
        ...
        find_library(qwt_LIBRARY_DEBUG NAMES qwtd PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH)
    ...
    set_target_properties(unofficial::qwt::qwt PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/include"
    )
