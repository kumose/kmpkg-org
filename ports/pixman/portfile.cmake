...
if(KMPKG_TARGET_ARCHITECTURE IN_LIST x86_architectures AND NOT KMPKG_TARGET_IS_UWP)
    list(APPEND OPTIONS
        -Dmmx=enabled
        -Dsse2=enabled
        -Dssse3=enabled
    ...
    if(KMPKG_TARGET_IS_ANDROID)
        ...
        find_path(cpu_features_dir
            ...
            PATHS "${KMPKG_DETECTED_CMAKE_ANDROID_NDK}"
            PATH_SUFFIXES
                "sources/android/cpufeatures" # NDK r27c
            NO_DEFAULT_PATH
        )
        if(KMPKG_DETECTED_CMAKE_ANDROID_ARM_NEON AND cpu_features_dir)
            list(APPEND OPTIONS
...
kmpkg_install_copyright(FILE_LIST ${licenses})
