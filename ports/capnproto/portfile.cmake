...
if(KMPKG_TARGET_IS_WINDOWS AND NOT KMPKG_TARGET_IS_MINGW)
    ...
    set(KMPKG_CXX_FLAGS "${KMPKG_CXX_FLAGS} /bigobj")
    set(KMPKG_C_FLAGS "${KMPKG_C_FLAGS} /bigobj")
endif()
...
kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/CapnProto)

kmpkg_copy_tools(TOOL_NAMES capnp capnpc-c++ capnpc-capnp AUTO_CLEAN)
