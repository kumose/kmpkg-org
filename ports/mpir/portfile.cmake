...
if(NOT KMPKG_TARGET_IS_WINDOWS)
    kmpkg_find_acquire_program(YASM)
    ...
    string(APPEND KMPKG_C_FLAGS " -Wno-implicit-function-declaration")
    string(APPEND KMPKG_CXX_FLAGS " -Wno-implicit-function-declaration")
    ...
    set(MSVC_VERSION 14)
    if(KMPKG_PLATFORM_TOOLSET MATCHES "v14(1|2|3)")
        set(MSVC_VERSION 15)
    endif()
    ...
    # Note: Could probably be moved to use kmpkg_configure_make on windows
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/COPYING" "${SOURCE_PATH}/COPYING.LIB")
