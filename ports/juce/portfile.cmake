set(KMPKG_BUILD_TYPE release)  # no libraries
...
kmpkg_from_github(
  ...
  PATCHES
    ...
    juceaide.diff
    prefer-cmake.diff
    kmpkg-compile-definitions.diff
...
file(WRITE "${SOURCE_PATH}/extras/Build/CMake/kmpkg-compile-definitions.cmake" "
function(kmpkg_juce_add_compile_definitions target)
...
if(KMPKG_CROSSCOMPILING)
  # Constructed with CURRENT_INSTALLED_DIR, for kmpkg_cmake_config_fixup.
  list(APPEND FEATURE_OPTIONS "-DWITH_JUCEAIDE=${CURRENT_INSTALLED_DIR}/../${HOST_TRIPLET}/tools/${PORT}/juceaide${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
...
if(KMPKG_TARGET_EXECUTABLE_SUFFIX STREQUAL "")
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/lib")
  message(${Z_KMPKG_BACKCOMPAT_MESSAGE_LEVEL} "juce must not install files to ${CURRENT_PACKAGES_DIR}/lib.")
