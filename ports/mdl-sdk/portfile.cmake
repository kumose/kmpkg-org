...
if(KMPKG_HOST_IS_WINDOWS AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "x64"))
...
elseif(KMPKG_HOST_IS_LINUX AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "x64"))
...
elseif(KMPKG_HOST_IS_LINUX AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64"))
...
elseif(KMPKG_HOST_IS_OSX AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "x64"))
...
kmpkg_download_distfile(LLVM_ARCHIVE_PATH
...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_extract_source_archive(LLVM_DIRECTORY
        ARCHIVE "${LLVM_ARCHIVE_PATH}"
        SOURCE_BASE "clang+llvm-${LLVM_VERSION}"
    )
endif()

set(LLVM_CLANG "${LLVM_DIRECTORY}/bin/clang${KMPKG_HOST_EXECUTABLE_SUFFIX}")
...
# MDL-SDK
#
# Note about "supports:" in kmpkg.json:
...
kmpkg_cmake_config_fixup(PACKAGE_NAME "mdl")
