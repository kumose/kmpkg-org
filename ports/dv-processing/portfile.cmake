...
set(KMPKG_BUILD_TYPE release) # no lib binaries
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DDVP_BUILD_CONFIG_KMPKG=ON
)

kmpkg_cmake_install()

if(DVP_ENABLE_UTILITIES)
    kmpkg_copy_tools(TOOL_NAMES dv-filestat dv-imu-bias-estimation dv-list-devices dv-tcpstat AUTO_CLEAN)
endif()
