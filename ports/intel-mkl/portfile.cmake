...
if(NOT KMPKG_TARGET_ARCHITECTURE STREQUAL "x64")
  # nop
...
kmpkg_download_distfile(installer_path
...
set(main_pc_file "mkl-${KMPKG_LIBRARY_LINKAGE}-${interface}-${short_thread}.pc")
...
message(STATUS "Warning: This port is still a work on progress. 
  ...
  KMPKG_LIBRARY_LINKAGE. It is using the default threading (Intel OpenMP)
...
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/${main_pc_file}" "\${exec_prefix}/${package_libdir}" "\${exec_prefix}/lib/" IGNORE_UNCHANGED)
...
if(threading STREQUAL "intel_thread")
  ...
  kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/${main_pc_file}" "openmp" "libiomp5")
endif()
...
if(NOT KMPKG_BUILD_TYPE)
    ...
    foreach(file IN LISTS pc_files)
      ...
      kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/${file}" "/include" "/../include")
      if(NOT KMPKG_TARGET_IS_WINDOWS)
        kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/${file}" "/lib/" "/../lib/" IGNORE_UNCHANGED)
      endif()
    endforeach()
endif()

file(COPY "${mkl_dir}/lib/cmake/" DESTINATION "${CURRENT_PACKAGES_DIR}/share/")
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/mkl/MKLConfig.cmake" "MKL_CMAKE_PATH}/../../../" "MKL_CMAKE_PATH}/../../")
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/mkl/MKLConfig.cmake" "redist/\${MKL_ARCH}" "bin")
if(${KMPKG_LIBRARY_LINKAGE} STREQUAL "static")
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/mkl/MKLConfig.cmake" "define_param(MKL_LINK DEFAULT_MKL_LINK MKL_LINK_LIST)" 
...
kmpkg_install_copyright(FILE_LIST "${package_path}/licenses/license.htm")
