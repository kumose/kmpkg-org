...
if(KMPKG_TARGET_IS_WINDOWS AND (KMPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR KMPKG_TARGET_ARCHITECTURE STREQUAL "arm64"))
...
# quickcpplib parses CMAKE_MSVC_RUNTIME_LIBRARY and cannot support the default crt linkage generator expression from kmpkg
...
if(KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    kmpkg_cmake_build(TARGET install.dl)
elseif(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_cmake_build(TARGET install.sl)
endif()

if("run-tests" IN_LIST FEATURES)
    kmpkg_cmake_build(TARGET test)
endif()

kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/llfio)
...
file(INSTALL "${CURRENT_PORT_DIR}/usage-${_USAGE_FEATURE}-${KMPKG_LIBRARY_LINKAGE}" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}" RENAME usage)
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/Licence.txt")
