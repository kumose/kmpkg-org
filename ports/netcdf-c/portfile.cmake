...
if(NETCDF_ENABLE_DAP OR NETCDF_ENABLE_NCZARR)
    list(APPEND FEATURE_OPTIONS "-DKMPKG_LOCK_FIND_PACKAGE_CURL=ON")
else()
    list(APPEND FEATURE_OPTIONS "-DKMPKG_LOCK_FIND_PACKAGE_CURL=OFF")
endif()

if(KMPKG_TARGET_IS_UWP)
    string(APPEND KMPKG_C_FLAGS " /wd4996 /wd4703")
    string(APPEND KMPKG_CXX_FLAGS " /wd4996 /wd4703")
endif()
...
kmpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DKMPKG_LOCK_FIND_PACKAGE_MakeDist=OFF
        -DKMPKG_LOCK_FIND_PACKAGE_PkgConfig=OFF
        -DKMPKG_LOCK_FIND_PACKAGE_ZLIB=ON
        ${FEATURE_OPTIONS}
...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(CONFIG_PATH "lib/cmake/netCDF")
kmpkg_fixup_pkgconfig()

if(KMPKG_TARGET_IS_WINDOWS AND KMPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/netcdf.h" "defined(DLL_NETCDF)" "1")
endif()
...
kmpkg_install_copyright(FILE_LIST "${SOURCE_PATH}/COPYRIGHT" "${ncpoco_copyright}" "${ncpoco_source_license}")
