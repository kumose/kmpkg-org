if (KMPKG_TARGET_IS_WINDOWS OR KMPKG_TARGET_IS_IOS)
...
if ("cuda" IN_LIST FEATURES AND KMPKG_TARGET_ARCHITECTURE STREQUAL "x86")
    message(FATAL_ERROR "Feature 'cuda' can only build on x64 arch.")
endif()

if (("dx" IN_LIST FEATURES OR "omp" IN_LIST FEATURES) AND NOT KMPKG_TARGET_IS_WINDOWS)
...
if ("examples" IN_LIST FEATURES)
    if ("dx" IN_LIST FEATURES)
        kmpkg_copy_tools(TOOL_NAMES dxViewer AUTO_CLEAN)
        if ("ptex" IN_LIST FEATURES)
            kmpkg_copy_tools(TOOL_NAMES dxPtexViewer AUTO_CLEAN)
        endif()
    endif()
endif()

if ("tutorials" IN_LIST FEATURES)
    file(GLOB TUTORIALS_TOOLS "${CURRENT_PACKAGES_DIR}/bin/tutorials/*${KMPKG_TARGET_EXECUTABLE_SUFFIX}")
    ...
    if (TUTORIALS_TOOL_NAMES)
        kmpkg_copy_tools(TOOL_NAMES ${TUTORIALS_TOOL_NAMES} SEARCH_DIR "${CURRENT_PACKAGES_DIR}/bin/tutorials/" AUTO_CLEAN)
    endif()
endif()

kmpkg_copy_pdbs()
kmpkg_cmake_config_fixup(PACKAGE_NAME OpenSubdiv CONFIG_PATH lib/cmake/OpenSubdiv)
