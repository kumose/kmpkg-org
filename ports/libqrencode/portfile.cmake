...
if(KMPKG_TARGET_IS_WINDOWS) # Windows
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/qrencode${EXECUTABLE_SUFFIX}")
    ...
    kmpkg_copy_tool_dependencies("${CURRENT_PACKAGES_DIR}/tools/qrencode")
    if (NOT KMPKG_TARGET_IS_WINDOWS OR KMPKG_LIBRARY_LINKAGE STREQUAL static)
