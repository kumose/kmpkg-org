...
kmpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        vulkan  KMPKG_LOCK_FIND_PACKAGE_Vulkan
)

string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" DYNAMIC_LOADER)
...
if(KMPKG_TARGET_IS_WINDOWS)
    ...
    kmpkg_cmake_config_fixup(CONFIG_PATH lib/cmake/openxr)
endif()
