...
if(KMPKG_DETECTED_CMAKE_CROSSCOMPILING)
    message(STATUS [[
...
values directly with `KMPKG_CMAKE_CONFIGURE_OPTIONS` in a custom triplet file.
...
if ("tools" IN_LIST FEATURES)
    ...
    kmpkg_copy_tools(TOOL_NAMES ${_tools} AUTO_CLEAN)
endif()
...
# no absolute paths
kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/dcmtk/config/osconfig.h"
    "#define (DCMTK_PREFIX|DCM_DICT_DEFAULT_PATH|DEFAULT_CONFIGURATION_DIR|DEFAULT_SUPPORT_DATA_DIR) \"[^\"]*\""
    "#define \\1 \"\" /* redacted by kmpkg */"
    REGEX
)
