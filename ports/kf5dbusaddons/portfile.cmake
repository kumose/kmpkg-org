...
kmpkg_cmake_install()
kmpkg_cmake_config_fixup(PACKAGE_NAME KF5DBusAddons CONFIG_PATH lib/cmake/KF5DBusAddons)
...
elseif(KMPKG_TARGET_IS_WINDOWS)
    ...
    file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin/kquitapp5${KMPKG_HOST_EXECUTABLE_SUFFIX}" "${CURRENT_PACKAGES_DIR}/debug/bin/kquitapp5${KMPKG_HOST_EXECUTABLE_SUFFIX}")
endif()
