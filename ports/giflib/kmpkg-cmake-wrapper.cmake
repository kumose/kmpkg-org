find_path(GIF_INCLUDE_DIR NAMES gif_lib.h PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/include" NO_DEFAULT_PATH)
find_library(GIF_LIBRARY_RELEASE NAMES gif PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH)
find_library(GIF_LIBRARY_DEBUG   NAMES gif PATHS "${_KMPKG_INSTALLED_DIR}/${KMPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH)
