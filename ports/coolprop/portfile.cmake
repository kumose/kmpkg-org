...
kmpkg_replace_string("${SOURCE_PATH}/CMakeLists.txt" "CACHE LIST" "CACHE STRING")
...
kmpkg_replace_string("${SOURCE_PATH}/externals/rapidjson/include/rapidjson/document.h" "thread_local static " "static thread_local ")

string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "dynamic" COOLPROP_SHARED_LIBRARY)
string(COMPARE EQUAL "${KMPKG_LIBRARY_LINKAGE}" "static" COOLPROP_STATIC_LIBRARY)

string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "dynamic" COOLPROP_MSVC_DYNAMIC)
string(COMPARE EQUAL "${KMPKG_CRT_LINKAGE}" "static" COOLPROP_MSVC_STATIC)
...
if (KMPKG_TARGET_IS_WINDOWS AND COOLPROP_SHARED_LIBRARY)
    kmpkg_replace_string(${CURRENT_PACKAGES_DIR}/include/CoolPropLib.h
