...
function(qt_build_submodule SOURCE_PATH)
    if(NOT PORT STREQUAL "qt5-webengine")
        ...
        kmpkg_add_to_path("${PYTHON3_EXE_PATH}")
    endif()

    kmpkg_configure_qmake(SOURCE_PATH ${SOURCE_PATH} ${ARGV})

    kmpkg_build_qmake(SKIP_MAKEFILES)
    ...
    kmpkg_build_qmake(TARGETS install SKIP_MAKEFILES BUILD_LOGNAME install)

    qt_fix_cmake(${CURRENT_PACKAGES_DIR} ${PORT})
    kmpkg_fixup_pkgconfig() # Needs further investigation if this is enough!
    ...
    # Remove duplicate flags from qmodule.pri issue -> https://github.com/microsoft/kmpkg/issues/28835
