...
if(KMPKG_TARGET_IS_UWP)
    string(APPEND KMPKG_C_FLAGS " /wd4146")
    string(APPEND KMPKG_CXX_FLAGS " /wd4146")
endif()
...
if(JPEGXL_ENABLE_TOOLS)
    kmpkg_copy_tools(TOOL_NAMES cjxl djxl jxlinfo AUTO_CLEAN)
endif()

if(KMPKG_LIBRARY_LINKAGE STREQUAL "static")
    kmpkg_replace_string("${CURRENT_PACKAGES_DIR}/include/jxl/jxl_export.h" "ifdef JXL_STATIC_DEFINE" "if 1")
endif()
