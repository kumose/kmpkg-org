...
if(KMPKG_CROSSCOMPILING)
    set(corrade_rc_param
        "-DCORRADE_RC_EXECUTABLE=${CURRENT_HOST_INSTALLED_DIR}/tools/corrade/corrade-rc${KMPKG_HOST_EXECUTABLE_SUFFIX}"
    )
endif()
...
kmpkg_copy_tools(TOOL_NAMES "corrade-rc" AUTO_CLEAN)
