...
if("jasper" IN_LIST FEATURES)
    ...
    x_kmpkg_pkgconfig_get_modules(PREFIX jasper MODULES jasper LIBS)

    file(READ "${CURRENT_INSTALLED_DIR}/share/jasper/kmpkg_abi_info.txt" jasper_abi_info)
...
if("tiff" IN_LIST FEATURES)
    ...
    x_kmpkg_pkgconfig_get_modules(PREFIX tiff MODULES libtiff-4 LIBS)
...
if("webp" IN_LIST FEATURES)
    ...
    x_kmpkg_pkgconfig_get_modules(PREFIX webp MODULES libwebp libwebpdemux libwebpmux libwebpdecoder LIBS)
